...
Przepisany fragment „Listy wymienników” z Twojego planu diety. Znak `=` znaczy: możesz wymienić jedno na drugie.
...
<p>Mąka jaglana = mąka gryczana = mąka żytnia typ 2000 = mąka ryżowa = mąka z tapioki = mąka amarantusowa = mąka orkiszowa = mąka pełnoziarnista = mąka owsiana</p>
<p>Płatki owsiane = płatki jaglane = płatki gryczane = płatki ryżowe = płatki orkiszowe</p>
<p>Ryż biały = ryż basmati = ryż brązowy = ryż dziki = komosa ryżowa = kasza gryczana = kasza jaglana = kasza pęczak = kasza bulgur = kasza owsiana = kasza jęczmienna = amarantus = makaron gryczany = makaron jaglany = makaron żytni = makaron ryżowy = makaron pełnoziarnisty = makaron orkiszowy = makaron bezglutenowy</p>
<p>Ziemniaki = bataty = topinambur</p>
<p>100 g ryżu / kaszy = 450-500 g ziemniaków</p>
<p>Chleb żytni razowy = chleb żytni na zakwasie = chleb orkiszowy = chleb pełnoziarnisty = chleb bezglutenowy = bułka owsiana = bułka grahamka = bułka pełnoziarnista</p>
<p>Hummus = pasty warzywne</p>
...
<p>Ciecierzyca = soczewica = fasola = groch = soja</p>
<p>Serek wiejski = ser twarogowy chudy = tofu naturalne</p>
