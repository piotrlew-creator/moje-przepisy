...
Wybierz porę posiłku, zaznacz produkty, na które masz ochotę — albo po prostu przewiń wszystkie 263 przepisy z Twoich planów.
...
<label class="p-chip" data-rank="top" data-label="Banan"><input type="checkbox" value="banan">Banan <span class="p-num" style="opacity:.55">29</span></label>
...
<label class="p-chip" data-rank="top" data-label="Jogurt / skyr"><input type="checkbox" value="jogurt">Jogurt / skyr <span class="p-num" style="opacity:.55">51</span></label>
...
<label class="p-chip" data-rank="top" data-label="Orzechy"><input type="checkbox" value="orzechy">Orzechy <span class="p-num" style="opacity:.55">42</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Oliwa / olej" hidden><input type="checkbox" value="oliwa">Oliwa / olej <span class="p-num" style="opacity:.55">116</span></label>
<label class="p-chip" data-rank="rest" data-label="Cebula" hidden><input type="checkbox" value="cebula">Cebula <span class="p-num" style="opacity:.55">65</span></label>
<label class="p-chip" data-rank="rest" data-label="Czosnek" hidden><input type="checkbox" value="czosnek">Czosnek <span class="p-num" style="opacity:.55">59</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Marchewka" hidden><input type="checkbox" value="marchewka">Marchewka <span class="p-num" style="opacity:.55">31</span></label>
<label class="p-chip" data-rank="rest" data-label="Sałata / rukola / roszponka" hidden><input type="checkbox" value="salata">Sałata / rukola / roszponka <span class="p-num" style="opacity:.55">30</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Pomidory z puszki / passata" hidden><input type="checkbox" value="pomidory-puszka">Pomidory z puszki / passata <span class="p-num" style="opacity:.55">24</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Czekolada" hidden><input type="checkbox" value="czekolada">Czekolada <span class="p-num" style="opacity:.55">18</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Seler" hidden><input type="checkbox" value="seler">Seler <span class="p-num" style="opacity:.55">11</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Miód" hidden><input type="checkbox" value="miod">Miód <span class="p-num" style="opacity:.55">9</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Truskawki" hidden><input type="checkbox" value="truskawki">Truskawki <span class="p-num" style="opacity:.55">8</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Borówki" hidden><input type="checkbox" value="borowki">Borówki <span class="p-num" style="opacity:.55">7</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Ananas" hidden><input type="checkbox" value="ananas">Ananas <span class="p-num" style="opacity:.55">6</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Pietruszka korzeń" hidden><input type="checkbox" value="pietruszka-korzen">Pietruszka korzeń <span class="p-num" style="opacity:.55">5</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Hummus" hidden><input type="checkbox" value="hummus">Hummus <span class="p-num" style="opacity:.55">4</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Pomarańcza" hidden><input type="checkbox" value="pomarancza">Pomarańcza <span class="p-num" style="opacity:.55">4</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Baton / przekąska" hidden><input type="checkbox" value="baton">Baton / przekąska <span class="p-num" style="opacity:.55">2</span></label>
...
<label class="p-chip" data-rank="rest" data-label="Pudding proteinowy" hidden><input type="checkbox" value="pudding">Pudding proteinowy <span class="p-num" style="opacity:.55">1</span></label>
...
<p class="p-hint" id="ing-hint">Widzisz 20 najczęstszych składników. Pozostałe 125 znajdziesz przez wyszukiwanie.</p>
</div>
</details>
</div>
<div class="p-count" role="status" aria-live="polite"><span id="result-count" class="p-num"></span></div>
