...
<button type="button" class="p-fav p-fav--hero" data-fav="gyoza" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
<div class="p-macro"><span class="p-macro__v">358</span><span class="p-macro__l">kcal</span></div>
...
<li><div class="p-ing__row"><span class="p-ing__q">1 op.</span><span class="p-ing__n">Pierożków gyoza z warzywami chef select</span><span class="p-ing__g">230 g</span></div>
</li>
...
<li><span class="p-step__text">Pierożki podgrzej wg instrukcji na opakowaniu. Na deser zjedz mandarynkę.</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Pierożki gyoza z warzywami chef select z kimchi">
<div class="p-cook__bar">
<span class="p-cook__title">Pierożki gyoza z warzywami chef select z kimchi</span>
...
<script>window.RECIPE = {"slug": "gyoza", "title": "Pierożki gyoza z warzywami chef select z kimchi", "slotLabel": "Obiad", "time": "13:00-16:00", "baseServings": 1, "kcal": 358, "times": [null], "ingredients": [{"qty": 1.0, "unit": "opakowanie", "unitLemma": "opakowanie", "name": "Pierożków gyoza z warzywami chef select", "grams": 230.0, "pantry": false, "tag": "gyoza", "dzial": "chlodnia"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "mandarynki", "grams": 65.0, "pantry": false, "tag": "mandarynka", "swap": {"group": "owoce", "self": "mandarynka", "nameCase": "D"}, "dzial": "warzywa"}], "steps": ["Pierożki podgrzej wg instrukcji na opakowaniu. Na deser zjedz «1|B|||»."]};
