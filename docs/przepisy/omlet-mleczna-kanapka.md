...
<button type="button" class="p-fav p-fav--hero" data-fav="omlet-mleczna-kanapka" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">1 szt.</span><span class="p-ing__n">jajko</span><span class="p-ing__g">56 g</span></div>
</li>
...
<li data-sec="180"><span class="p-step__text">Składniki omletu mieszaj lub zblenduj ze sobą, smaż na patelni pod przykryciem przez 3-5 minut na średnim ogniu.</span><button type="button" class="p-timer__btn" data-timer="0">&#9201; 3:00</button></li>
<li><span class="p-step__text">Składniki kremu zblenduj na gładką masę.</span></li>
<li><span class="p-step__text">Omlet ściągnij z patelni. Odstaw, żeby nieco ostygł. Posmaruj kremem i złóż na pół. Smacznego!</span></li>
</ol>
...
<script>window.RECIPE = {"slug": "omlet-mleczna-kanapka", "title": "Omlet mleczna kanapka", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 454, "times": [180, null, null], "ingredients": [{"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "jajko", "grams": 56.0, "pantry": false, "tag": "jajka", "dzial": "nabial"}, {"qty": 2.5, "unit": "łyżki", "unitLemma": "łyżka", "name": "mąki pszennej pełnoziarnistej", "grams": 35.0, "pantry": false, "tag": "maka", "dzial": "sypkie"}, {"qty": 1.0, "unit": "łyżka", "unitLemma": "łyżka", "name": "kakao", "grams": 10.0, "pantry": false, "tag": "kakao", "dzial": "bakalie"}, {"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "jogurtu naturalnego", "grams": 60.0, "pantry": false, "tag": "jogurt", "dzial": "nabial"}, {"qty": 0.5, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "proszku do pieczenia", "grams": 2.0, "pantry": true, "tag": null, "dzial": "sypkie"}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "jogurtu naturalnego", "grams": 40.0, "pantry": false, "tag": "jogurt", "dzial": "nabial"}, {"qty": 3.0, "unit": "plastry", "unitLemma": "plaster", "name": "twarogu chudego", "grams": 90.0, "pantry": false, "tag": "twarog", "swap": {"group": "twarogowe", "self": "twarog-chudy", "nameCase": "D"}, "dzial": "nabial"}, {"qty": 1.5, "unit": "łyżki", "unitLemma": "łyżka", "name": "ksylitolu", "grams": 23.0, "pantry": true, "tag": null, "dzial": "bakalie"}, {"qty": 1.0, "unit": "łyżeczka", "unitLemma": "łyżeczka", "name": "ekstraktu waniliowego", "grams": 3.0, "pantry": true, "tag": null, "dzial": "sosy"}], "steps": ["Składniki omletu mieszaj lub zblenduj ze sobą, smaż na patelni pod przykryciem przez 3-5 minut na średnim ogniu.", "Składniki kremu zblenduj na gładką masę.", "Omlet ściągnij z patelni. Odstaw, żeby nieco ostygł. Posmaruj kremem i złóż na pół. Smacznego!"]};
