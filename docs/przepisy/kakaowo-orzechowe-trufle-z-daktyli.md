...
# Kakaowo-orzechowe trufle z daktyli

<div class="p-hero" data-slot="3">
<div class="p-hero__top">
<span>Kolacja</span><span class="p-num">18:00-20:00</span>
<button type="button" class="p-fav p-fav--hero" data-fav="kakaowo-orzechowe-trufle-z-daktyli" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">10 szt.</span><span class="p-ing__n">daktyli świeżych</span><span class="p-ing__g">50 g</span></div>
</li>
...
<li data-sec="1200"><span class="p-step__text">Daktyle namocz we wrzątku przez 20 minut.</span><button type="button" class="p-timer__btn" data-timer="0">&#9201; 20:00</button></li>
<li><span class="p-step__text">Daktyle zmiksuj z odżywką na gładką masę. Dodaj kakao i posiekane orzechy, wymieszaj.</span></li>
<li><span class="p-step__text">Uformuj kulki i obtocz w kakao.</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Kakaowo-orzechowe trufle z daktyli">
<div class="p-cook__bar">
<span class="p-cook__title">Kakaowo-orzechowe trufle z daktyli</span>
...
<script>window.RECIPE = {"slug": "kakaowo-orzechowe-trufle-z-daktyli", "title": "Kakaowo-orzechowe trufle z daktyli", "slotLabel": "Kolacja", "time": "18:00-20:00", "baseServings": 1, "kcal": 463, "times": [1200, null, null], "ingredients": [{"qty": 10.0, "unit": "sztuk", "unitLemma": "sztuka", "name": "daktyli świeżych", "grams": 50.0, "pantry": false, "tag": "daktyle", "dzial": "bakalie"}, {"qty": 1.5, "unit": "łyżki", "unitLemma": "łyżka", "name": "kakao", "grams": 15.0, "pantry": false, "tag": "kakao", "dzial": "bakalie"}, {"qty": 1.0, "unit": "garść", "unitLemma": "garść", "name": "orzechów", "grams": 30.0, "pantry": false, "tag": "orzechy", "dzial": "bakalie"}, {"qty": 2.5, "unit": "łyżki", "unitLemma": "łyżka", "name": "wegańskiej odżywki białkowej", "grams": 20.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}], "steps": ["Daktyle namocz we wrzątku przez 20 minut.", "Daktyle zmiksuj z odżywką na gładką masę. Dodaj kakao i posiekane orzechy, wymieszaj.", "Uformuj kulki i obtocz w kakao."]};
