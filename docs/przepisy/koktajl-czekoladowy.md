...
<button type="button" class="p-fav p-fav--hero" data-fav="koktajl-czekoladowy" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">1 szklanka</span><span class="p-ing__n">napoju migdałowego</span><span class="p-ing__g">250 g</span></div>
<div class="p-ing__swap">
...
<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Koktajl czekoladowy">
<div class="p-cook__bar">
<span class="p-cook__title">Koktajl czekoladowy</span>
...
<script>window.RECIPE = {"slug": "koktajl-czekoladowy", "title": "Koktajl czekoladowy", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 469, "times": [null], "ingredients": [{"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "banana", "grams": 120.0, "pantry": false, "tag": "banan", "swap": {"group": "owoce", "self": "banan", "nameCase": "D"}, "dzial": "warzywa"}, {"qty": 2.5, "unit": "łyżki", "unitLemma": "łyżka", "name": "wegańskiej odżywki białkowej", "grams": 20.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}, {"qty": 1.0, "unit": "łyżka", "unitLemma": "łyżka", "name": "kakao", "grams": 10.0, "pantry": false, "tag": "kakao", "dzial": "bakalie"}, {"qty": 2.5, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "masła orzechowego", "grams": 25.0, "pantry": false, "tag": "maslo-orzechowe", "dzial": "bakalie"}, {"qty": 1.0, "unit": "szklanka", "unitLemma": "szklanka", "name": "napoju migdałowego", "grams": 250.0, "pantry": false, "tag": "mleko", "swap": {"group": "mleko", "self": "napoj-migdalowy", "nameCase": "M"}, "dzial": "nabial"}], "steps": ["Zblenduj wszystkie składniki. W razie potrzeby dodaj wody."]};
