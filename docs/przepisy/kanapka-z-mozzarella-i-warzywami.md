...
<button type="button" class="p-fav p-fav--hero" data-fav="kanapka-z-mozzarella-i-warzywami" aria-pressed="false" aria-label="Dodaj do ulubionych"><span aria-hidden="true">&#9825;</span></button>
</div>
<div class="p-macros">
...
<script>window.RECIPE = {"slug": "kanapka-z-mozzarella-i-warzywami", "title": "Kanapka z mozzarellą i warzywami", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 484, "times": [null], "ingredients": [{"qty": 2.0, "unit": "kromki", "unitLemma": "kromka", "name": "chleba żytniego", "grams": 60.0, "pantry": false, "tag": "chleb", "swap": {"group": "pieczywo", "self": "chleb-zytni", "nameCase": "D"}}, {"qty": 0.5, "unit": "garści", "unitLemma": "garść", "name": "szpinaku", "grams": 12.0, "pantry": false, "tag": "szpinak", "swap": {"group": "liscizielone", "self": "szpinak", "nameCase": "D"}}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "mozzarelli", "grams": 120.0, "pantry": false, "tag": "mozzarella"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "małego pomidora", "grams": 50.0, "pantry": false, "tag": "pomidor"}], "steps": ["Na kromkach chleba ułóż «1|B|||» oraz pokrojoną w plastry mozzarellę, pomidora"]};
