...
<button type="button" class="p-fav p-fav--hero" data-fav="zupa-krem-z-pomidorow" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">1 op.</span><span class="p-ing__n">Zupy krem z pomidorów z bazylią Chef select</span><span class="p-ing__g">450 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">1 szt.</span><span class="p-ing__n">batona Raw Alesto kakao, ziarna kakaowca</span><span class="p-ing__g">50 g</span></div>
</li>
</ul>
...
<li><span class="p-step__text">Podgrzej zupę wg instrukcji na opakowaniu. Na deser zjedz batona.</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Zupa krem z pomidorów z bazylią Chef select">
<div class="p-cook__bar">
<span class="p-cook__title">Zupa krem z pomidorów z bazylią Chef select</span>
...
<script>window.RECIPE = {"slug": "zupa-krem-z-pomidorow", "title": "Zupa krem z pomidorów z bazylią Chef select", "slotLabel": "Obiad", "time": "13:00-16:00", "baseServings": 1, "kcal": 370, "times": [null], "ingredients": [{"qty": 1.0, "unit": "opakowanie", "unitLemma": "opakowanie", "name": "Zupy krem z pomidorów z bazylią Chef select", "grams": 450.0, "pantry": false, "tag": "zupa-gotowa", "dzial": "napoje"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "batona Raw Alesto kakao, ziarna kakaowca", "grams": 50.0, "pantry": false, "tag": "baton", "dzial": "bakalie"}], "steps": ["Podgrzej zupę wg instrukcji na opakowaniu. Na deser zjedz batona."]};
