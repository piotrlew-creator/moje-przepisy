...
<button type="button" class="p-fav p-fav--hero" data-fav="ryz-na-mleku-z-czekolada-i" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
<div class="p-macro"><span class="p-macro__v">544</span><span class="p-macro__l">kcal</span></div>
<div class="p-macro"><span class="p-macro__v">21 g</span><span class="p-macro__l">białko</span></div>
<div class="p-macro"><span class="p-macro__v">88 g</span><span class="p-macro__l">węgl.</span></div>
...
<li><div class="p-ing__row"><span class="p-ing__q">4 łyżki</span><span class="p-ing__n">ryżu białego</span><span class="p-ing__g">60 g</span></div>
</li>
...
<li><div class="p-ing__row"><span class="p-ing__q">2 porcje</span><span class="p-ing__n">czekolady gorzkiej</span><span class="p-ing__g">20 g</span></div>
</li>
...
<li><span class="p-step__text">Zagotuj mleko.</span></li>
<li><span class="p-step__text">Do gotującego się mleka dodaj ryż, gotuj na małym ogniu do miękkości, mieszając co jakiś czas.</span></li>
<li><span class="p-step__text">Gdy ryż będzie gotowy, dodaj pokruszoną czekoladę, odżywkę białkową i ksylitol. Dokładnie wymieszaj.</span></li>
<li><span class="p-step__text">Ryż przełóż do miseczki i posyp malinami. Smacznego!</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Ryż na mleku z czekoladą i malinami">
<div class="p-cook__bar">
<span class="p-cook__title">Ryż na mleku z czekoladą i malinami</span>
...
<script>window.RECIPE = {"slug": "ryz-na-mleku-z-czekolada-i", "title": "Ryż na mleku z czekoladą i malinami", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 544, "times": [null, null, null, null], "ingredients": [{"qty": 4.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "ryżu białego", "grams": 60.0, "pantry": false, "tag": "ryz", "dzial": "sypkie"}, {"qty": 1.0, "unit": "szklanka", "unitLemma": "szklanka", "name": "mleka roślinnego", "grams": 250.0, "pantry": false, "tag": "mleko", "swap": {"group": "mleko", "self": "mleko-roslinne", "nameCase": "D"}, "dzial": "nabial"}, {"qty": 2.0, "unit": "porcje", "unitLemma": "porcja", "name": "czekolady gorzkiej", "grams": 20.0, "pantry": false, "tag": "czekolada", "dzial": "bakalie"}, {"qty": 1.0, "unit": "garść", "unitLemma": "garść", "name": "malin", "grams": 70.0, "pantry": false, "tag": "maliny", "dzial": "warzywa"}, {"qty": 1.0, "unit": "łyżeczka", "unitLemma": "łyżeczka", "name": "ksylitolu", "grams": 7.0, "pantry": true, "tag": null, "dzial": "bakalie"}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "wegańskiej odżywki białkowej", "grams": 16.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}], "steps": ["Zagotuj mleko.", "Do gotującego się mleka dodaj ryż, gotuj na małym ogniu do miękkości, mieszając co jakiś czas.", "Gdy ryż będzie gotowy, dodaj pokruszoną czekoladę, odżywkę białkową i ksylitol. Dokładnie wymieszaj.", "Ryż przełóż do miseczki i posyp malinami. Smacznego!"]};
