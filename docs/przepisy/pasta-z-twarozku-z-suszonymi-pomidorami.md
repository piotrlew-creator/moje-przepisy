...
# Pasta z twarożku z suszonymi pomidorami, szczypiorkiem, liśćmi szpinaku, pomidorem i ciemnym pieczywem

<div class="p-hero" data-slot="1">
<div class="p-hero__top">
<span>Śniadanie</span><span class="p-num">7:00-10:00</span>
<button type="button" class="p-fav p-fav--hero" data-fav="pasta-z-twarozku-z-suszonymi-pomidorami" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">1 op.</span><span class="p-ing__n">twarożku</span><span class="p-ing__g">200 g</span></div>
</li>
...
<li><div class="p-ing__row"><span class="p-ing__q">2 kromki</span><span class="p-ing__n">chleb żytniego razowego</span><span class="p-ing__g">60 g</span></div>
</li>
...
<li><span class="p-step__text">Twarożek wymieszaj z posiekanymi suszonymi pomidorami, szczypiorkiem, solą i pieprzem</span></li>
<li><span class="p-step__text">Pokrój pomidora i umyj szpinak.</span></li>
<li><span class="p-step__text">Twarożek podaj z pomidorami, szpinakiem i pieczywem posmarowanym masłem.</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Pasta z twarożku z suszonymi pomidorami, szczypiorkiem, liśćmi szpinaku, pomidorem i ciemnym pieczywem">
<div class="p-cook__bar">
<span class="p-cook__title">Pasta z twarożku z suszonymi pomidorami, szczypiorkiem, liśćmi szpinaku, pomidorem i ciemnym pieczywem</span>
...
<script>window.RECIPE = {"slug": "pasta-z-twarozku-z-suszonymi-pomidorami", "title": "Pasta z twarożku z suszonymi pomidorami, szczypiorkiem, liśćmi szpinaku, pomidorem i ciemnym pieczywem", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 478, "times": [null, null, null], "ingredients": [{"qty": 1.0, "unit": "opakowanie", "unitLemma": "opakowanie", "name": "twarożku", "grams": 200.0, "pantry": false, "tag": "serek-smietankowy", "dzial": "nabial"}, {"qty": 1.0, "unit": "garść", "unitLemma": "garść", "name": "szpinaku", "grams": 25.0, "pantry": false, "tag": "szpinak", "swap": {"group": "liscizielone", "self": "szpinak", "nameCase": "D"}, "dzial": "warzywa"}, {"qty": 0.5, "unit": "sztuki", "unitLemma": "sztuka", "name": "pomidora", "grams": 80.0, "pantry": false, "tag": "pomidor", "swap": {"group": "warzywa", "self": "pomidor", "nameCase": "D"}, "dzial": "warzywa"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "suszonych pomidorów", "grams": 20.0, "pantry": false, "tag": "pomidory-suszone", "dzial": "konserwy"}, {"qty": 2.0, "unit": "kromki", "unitLemma": "kromka", "name": "chleb żytniego razowego", "grams": 60.0, "pantry": false, "tag": "chleb", "dzial": "pieczywo"}, {"qty": 2.0, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "masła", "grams": 10.0, "pantry": false, "tag": "maslo", "dzial": "nabial"}, {"qty": 1.0, "unit": "łyżeczka", "unitLemma": "łyżeczka", "name": "szczypiorku", "grams": 5.0, "pantry": true, "tag": null, "dzial": "warzywa"}], "steps": ["Twarożek wymieszaj z posiekanymi suszonymi «2|Npl|||», szczypiorkiem, solą i pieprzem", "Pokrój «2|Bpot|||» i umyj «1|B|||».", "Twarożek podaj z «2|Npl|||», «1|N|||» i pieczywem posmarowanym masłem."]};
