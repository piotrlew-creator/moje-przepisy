...
<button type="button" class="p-fav p-fav--hero" data-fav="kanapka-z-wedzonym-lososiem" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">2 łyżki</span><span class="p-ing__n">serka śmietankowego</span><span class="p-ing__g">50 g</span></div>
</li>
...
<li><div class="p-ing__row"><span class="p-ing__q">1 łyżka</span><span class="p-ing__n">kiełków np. rzodkiewki</span><span class="p-ing__g">8 g</span></div>
</li>
...
<li><span class="p-step__text">Bułkę przekrój na pół i podpiecz na patelni</span></li>
<li><span class="p-step__text">Chrzan połącz z serkiem i posmaruj połówki bułki</span></li>
<li><span class="p-step__text">Na jednej połówce ułóż łososia, posiekany koperek, ogórka i kiełki</span></li>
<li><span class="p-step__text">Przykryj drugą połówką bułki</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Kanapka z wędzonym łososiem">
<div class="p-cook__bar">
<span class="p-cook__title">Kanapka z wędzonym łososiem</span>
...
<script>window.RECIPE = {"slug": "kanapka-z-wedzonym-lososiem", "title": "Kanapka z wędzonym łososiem", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 474, "times": [null, null, null, null], "ingredients": [{"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "bułki grahamki", "grams": 80.0, "pantry": false, "tag": "bulka", "swap": {"group": "pieczywo", "self": "bulka-grahamka", "nameCase": "D"}, "dzial": "pieczywo"}, {"qty": 3.0, "unit": "porcje", "unitLemma": "porcja", "name": "łososia wędzonego", "grams": 90.0, "pantry": false, "tag": "losos", "dzial": "mrozone"}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "serka śmietankowego", "grams": 50.0, "pantry": false, "tag": "serek-smietankowy", "dzial": "nabial"}, {"qty": 1.0, "unit": "łyżeczka", "unitLemma": "łyżeczka", "name": "chrzanu", "grams": 10.0, "pantry": false, "tag": "chrzan", "dzial": "sosy"}, {"qty": 1.0, "unit": "łyżeczka", "unitLemma": "łyżeczka", "name": "koperku", "grams": 4.0, "pantry": true, "tag": null, "dzial": "warzywa"}, {"qty": 1.0, "unit": "łyżka", "unitLemma": "łyżka", "name": "kiełków np. rzodkiewki", "grams": 8.0, "pantry": false, "tag": "kielki", "dzial": "warzywa"}, {"qty": 0.5, "unit": "sztuki", "unitLemma": "sztuka", "name": "ogórka", "grams": 75.0, "pantry": false, "tag": "ogorek", "swap": {"group": "warzywa", "self": "ogorek", "nameCase": "D"}, "dzial": "warzywa"}], "steps": ["Bułkę przekrój na pół i podpiecz na patelni", "Chrzan połącz z serkiem i posmaruj połówki bułki", "Na jednej połówce ułóż łososia, posiekany koperek, «6|Bpot|||» i kiełki", "Przykryj drugą połówką bułki"]};
