...
<button type="button" class="p-fav p-fav--hero" data-fav="owsianka" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">1 garść</span><span class="p-ing__n">orzechów nerkowca</span><span class="p-ing__g">30 g</span></div>
<div class="p-ing__swap">
...
<option value="orzechy-nerkowca" selected>Orzechy nerkowca · oryginał</option>
...
<li data-sec="180"><span class="p-step__text">Płatki owsiane zalej wrzątkiem do linii płatków, pozostaw na 3 minuty</span><button type="button" class="p-timer__btn" data-timer="0">&#9201; 3:00</button></li>
<li><span class="p-step__text">Banana pokrój w plasterki, dodaj odżywkę białkową i nerkowce</span></li>
<li><span class="p-step__text">Całość wymieszaj i gotowe! Smacznego!</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Owsianka">
<div class="p-cook__bar">
<span class="p-cook__title">Owsianka</span>
...
<script>window.RECIPE = {"slug": "owsianka", "title": "Owsianka", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 468, "times": [180, null, null], "ingredients": [{"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków owsianych", "grams": 30.0, "pantry": false, "tag": "platki-owsiane", "swap": {"group": "platki", "self": "platki-owsiane", "nameCase": "D"}, "dzial": "sypkie"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "małego banana", "grams": 100.0, "pantry": false, "tag": "banan", "swap": {"group": "owoce", "self": "banan", "nameCase": "D"}, "dzial": "warzywa"}, {"qty": 1.0, "unit": "garść", "unitLemma": "garść", "name": "orzechów nerkowca", "grams": 30.0, "pantry": false, "tag": "orzechy", "swap": {"group": "orzechy", "self": "orzechy-nerkowca", "nameCase": "D"}, "dzial": "bakalie"}, {"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "odżywki białkowej", "grams": 24.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}], "steps": ["«0|B|||U» zalej wrzątkiem do linii płatków, pozostaw na 3 minuty", "«1|Bpot|||U» pokrój w plasterki, dodaj odżywkę białkową i nerkowce", "Całość wymieszaj i gotowe! Smacznego!"]};
