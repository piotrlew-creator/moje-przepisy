...
# Owsianka z kawałkami kiwi oraz borówkami

<div class="p-hero" data-slot="3">
<div class="p-hero__top">
<span>Kolacja</span><span class="p-num">18:00-20:00</span>
<button type="button" class="p-fav p-fav--hero" data-fav="owsianka-z-kawalkami-kiwi-oraz-borowkami" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li data-order="name"><div class="p-ing__row"><span class="p-ing__q">6 łyżek</span><span class="p-ing__n">Płatki owsiane górskie</span><span class="p-ing__g">60 g</span></div>
</li>
<li data-order="name"><div class="p-ing__row"><span class="p-ing__q">7 łyżek</span><span class="p-ing__n">Jogurt skyr bez laktozy</span><span class="p-ing__g">140 g</span></div>
</li>
...
<li data-order="name"><div class="p-ing__row"><span class="p-ing__q"></span><span class="p-ing__n">Migdały</span><span class="p-ing__g">30 g</span></div>
</li>
</ul>
...
<li><span class="p-step__text">Płatki ugotuj w wodzie (250 ml) do miękkości. (możesz zalać gorącą wodą 1 cm ponad wysokość płatków i odstawić, żeby zmiękły).</span></li>
<li><span class="p-step__text">Wymieszaj z jogurtem skyr bez laktozy, borówkami oraz kawałkami kiwi.</span></li>
<li><span class="p-step__text">Posyp migdałami.</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Owsianka z kawałkami kiwi oraz borówkami">
<div class="p-cook__bar">
<span class="p-cook__title">Owsianka z kawałkami kiwi oraz borówkami</span>
...
<script>window.RECIPE = {"slug": "owsianka-z-kawalkami-kiwi-oraz-borowkami", "title": "Owsianka z kawałkami kiwi oraz borówkami", "slotLabel": "Kolacja", "time": "18:00-20:00", "baseServings": 1, "kcal": 600, "times": [null, null, null], "ingredients": [{"qty": 6.0, "unit": "łyżek", "unitLemma": "łyżka", "name": "Płatki owsiane górskie", "grams": 60.0, "pantry": false, "tag": "platki-owsiane", "nameFirst": true, "dzial": "sypkie"}, {"qty": 7.0, "unit": "łyżek", "unitLemma": "łyżka", "name": "Jogurt skyr bez laktozy", "grams": 140.0, "pantry": false, "tag": "jogurt", "nameFirst": true, "dzial": "nabial"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "Kiwi", "grams": 75.0, "pantry": false, "tag": "kiwi", "nameFirst": true, "swap": {"group": "owoce", "self": "kiwi", "nameCase": "M"}, "dzial": "warzywa"}, {"qty": 100.0, "unit": "g", "unitLemma": null, "name": "Borówki amerykańskie", "grams": 100.0, "pantry": false, "tag": "borowki", "nameFirst": true, "weightOnly": true, "dzial": "warzywa"}, {"qty": 30.0, "unit": "g", "unitLemma": null, "name": "Migdały", "grams": 30.0, "pantry": false, "tag": "migdaly", "nameFirst": true, "weightOnly": true, "dzial": "bakalie"}], "steps": ["Płatki ugotuj w wodzie (250 ml) do miękkości. (możesz zalać gorącą wodą 1 cm ponad wysokość płatków i odstawić, żeby zmiękły).", "Wymieszaj z jogurtem skyr bez laktozy, borówkami oraz kawałkami «2|B|||».", "Posyp migdałami."]};
