...
<button type="button" class="p-fav p-fav--hero" data-fav="klejacy-ryz" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">4 łyżki</span><span class="p-ing__n">mleczka kokosowego 12%</span><span class="p-ing__g">80 g</span></div>
</li>
</ul>
...
<li><span class="p-step__text">Jabłko pokrój w kostkę i dopraw cynamonem, w razie potrzeby dodaj ksylitol.</span></li>
<li><span class="p-step__text">Przyprawione jabłko duś w rondelku, aż puści soki i zacznie się rozpadać. Tak przygotowane jabłko przełóż do miseczki.</span></li>
<li><span class="p-step__text">Do rondelka po jabłkach wsyp ryż, odżywkę i zalej napojem roślinnym oraz mleczkiem kokosowym. Gotuj na wolnym ogniu.</span></li>
<li><span class="p-step__text">Gdy ryż zacznie się rozklejać, dołóż do niego około 2/3 masy jabłek, które wcześniej przygotowałeś.</span></li>
<li><span class="p-step__text">Wystarczająco gęsty i miękki ryż z jabłkami przełóż do miseczki, a na niego ułóż resztę jabłek, które Ci zostały. Smacznego!</span></li>
</ol>
...
<script>window.RECIPE = {"slug": "klejacy-ryz", "title": "Klejący ryż z prażonym jabłkiem", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 464, "times": [null, null, null, null, null], "ingredients": [{"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "ryżu basmati", "grams": 30.0, "pantry": false, "tag": "ryz", "swap": {"group": "zboza", "self": "ryz-basmati", "nameCase": "D"}, "dzial": "sypkie"}, {"qty": 0.5, "unit": "szklanki", "unitLemma": "szklanka", "name": "mleka roślinnego", "grams": 125.0, "pantry": false, "tag": "mleko", "swap": {"group": "mleko", "self": "mleko-roslinne", "nameCase": "D"}, "dzial": "nabial"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "jabłka", "grams": 150.0, "pantry": false, "tag": "jablko", "swap": {"group": "owoce", "self": "jablko", "nameCase": "D"}, "dzial": "warzywa"}, {"qty": 1.0, "unit": "łyżeczka", "unitLemma": "łyżeczka", "name": "cynamonu", "grams": 4.0, "pantry": true, "tag": null, "dzial": "sosy"}, {"qty": 1.0, "unit": "łyżka", "unitLemma": "łyżka", "name": "ksylitolu", "grams": 15.0, "pantry": true, "tag": null, "dzial": "bakalie"}, {"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "wegańskiej odżywki białkowej", "grams": 24.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}, {"qty": 4.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "mleczka kokosowego 12%", "grams": 80.0, "pantry": false, "tag": "mleczko-kokosowe", "dzial": "konserwy"}], "steps": ["«2|B|||U» pokrój w kostkę i dopraw cynamonem, w razie potrzeby dodaj ksylitol.", "«2|B|przyprawiony_B||U» duś w rondelku, aż puści soki i zacznie się rozpadać. Tak «2|B|przygotowany_B||» przełóż do miseczki.", "Do rondelka po «2|Mspl|||» wsyp ryż, odżywkę i zalej napojem roślinnym oraz mleczkiem kokosowym. Gotuj na wolnym ogniu.", "Gdy ryż zacznie się rozklejać, dołóż do niego około 2/3 masy «2|Dpl|||», które wcześniej przygotowałeś.", "Wystarczająco gęsty i miękki ryż z «2|Npl|||» przełóż do miseczki, a na niego ułóż resztę «2|Dpl|||», które Ci zostały. Smacznego!"]};
