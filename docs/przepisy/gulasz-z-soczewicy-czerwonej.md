...
<button type="button" class="p-fav p-fav--hero" data-fav="gulasz-z-soczewicy-czerwonej" aria-pressed="false" aria-label="Dodaj do ulubionych"><span aria-hidden="true">&#9825;</span></button>
</div>
<div class="p-macros">
...
<li data-order="name"><div class="p-ing__row"><span class="p-ing__q">0.5 op.</span><span class="p-ing__n">Pomidory z puszki</span><span class="p-ing__g">100 g</span></div>
</li>
...
<li><span class="p-step__text">Wszystkie warzywa pokrój w kostkę.</span></li>
<li><span class="p-step__text">W garnku rozgrzej oliwę. Podsmaż czosnek oraz cebulęm przez dwie minuty.</span></li>
<li data-sec="300"><span class="p-step__text">Dodaj cukinię oraz marchew. Smaż przez 5 minut, po tym czasie dodaj paprykę czerwoną i przyprawy.</span><button type="button" class="p-timer__btn" data-timer="2">&#9201; 5:00</button></li>
<li><span class="p-step__text">Wlej bulion warzywny oraz pomidory z puszki, dodaj pęczak oraz soczewicę czerwoną i wodę (1 cm ponad poziom warzyw).</span></li>
<li data-sec="1200"><span class="p-step__text">Gotuj przez 20 minut lub dłużej, do momentu, aż pęczak się ugotuje. W razie potrzeby dopraw solą oraz pieprzem. Smacznego!</span><button type="button" class="p-timer__btn" data-timer="4">&#9201; 20:00</button></li>
</ol>
