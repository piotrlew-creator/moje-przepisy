...
<button type="button" class="p-fav p-fav--hero" data-fav="kanapki-z-zielonym-pesto-serem-gouda" aria-pressed="false" aria-label="Dodaj do ulubionych"><span aria-hidden="true">&#9825;</span></button>
</div>
<div class="p-macros">
...
<script>window.RECIPE = {"slug": "kanapki-z-zielonym-pesto-serem-gouda", "title": "Kanapki z zielonym pesto, serem gouda i papryką czerwoną", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 577, "times": [null, null], "ingredients": [{"qty": 4.0, "unit": "kromki", "unitLemma": "kromka", "name": "Chleb bezglutenowy", "grams": 100.0, "pantry": false, "tag": "chleb", "nameFirst": true}, {"qty": 5.0, "unit": "łyżeczek", "unitLemma": "łyżeczka", "name": "Pesto zielone", "grams": 25.0, "pantry": false, "tag": "pesto", "nameFirst": true}, {"qty": 4.0, "unit": "plastry", "unitLemma": "plaster", "name": "Ser gouda", "grams": 60.0, "pantry": false, "tag": "gouda", "nameFirst": true}, {"qty": 0.5, "unit": "sztuki", "unitLemma": "sztuka", "name": "Papryka czerwona", "grams": 85.0, "pantry": false, "tag": "papryka", "nameFirst": true}], "steps": ["Chleb bezglutenowy posmaruj zielonym pesto.", "Na kanapki połóż ser gouda i pokrojone w paseczki lub kostkę warzywo. Resztę papryki czerwonej podaj dodatkowo na talerzu. Smacznego!"]};
