...
<button type="button" class="p-fav p-fav--hero" data-fav="jogurt-z-borowkami-i-orzechami" aria-pressed="false" aria-label="Dodaj do ulubionych"><span aria-hidden="true">&#9825;</span></button>
</div>
<div class="p-macros">
...
<script>window.RECIPE = {"slug": "jogurt-z-borowkami-i-orzechami", "title": "Jogurt z borówkami i orzechami", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 468, "times": [null], "ingredients": [{"qty": 1.0, "unit": "garść", "unitLemma": "garść", "name": "borówek świeżych lub mrożonych", "grams": 50.0, "pantry": false, "tag": "borowki"}, {"qty": 1.0, "unit": "opakowanie", "unitLemma": "opakowanie", "name": "jogurtu", "grams": 150.0, "pantry": false, "tag": "jogurt"}, {"qty": 1.5, "unit": "garści", "unitLemma": "garść", "name": "mieszanki orzechów", "grams": 45.0, "pantry": false, "tag": "orzechy"}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków owsianych", "grams": 20.0, "pantry": false, "tag": "platki-owsiane", "swap": {"group": "platki", "self": "platki-owsiane", "nameCase": "D"}}], "steps": ["Borówki wymieszaj z jogurtem, płatkami i orzechami. Smacznego!"]};
