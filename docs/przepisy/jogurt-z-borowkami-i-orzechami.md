...
<button type="button" class="p-fav p-fav--hero" data-fav="jogurt-z-borowkami-i-orzechami" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">1 garść</span><span class="p-ing__n">borówek świeżych lub mrożonych</span><span class="p-ing__g">50 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">1 op.</span><span class="p-ing__n">jogurtu</span><span class="p-ing__g">150 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">1.5 garści</span><span class="p-ing__n">mieszanki orzechów</span><span class="p-ing__g">45 g</span></div>
</li>
...
<li><span class="p-step__text">Borówki wymieszaj z jogurtem, płatkami i orzechami. Smacznego!</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Jogurt z borówkami i orzechami">
<div class="p-cook__bar">
<span class="p-cook__title">Jogurt z borówkami i orzechami</span>
...
<script>window.RECIPE = {"slug": "jogurt-z-borowkami-i-orzechami", "title": "Jogurt z borówkami i orzechami", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 468, "times": [null], "ingredients": [{"qty": 1.0, "unit": "garść", "unitLemma": "garść", "name": "borówek świeżych lub mrożonych", "grams": 50.0, "pantry": false, "tag": "borowki", "dzial": "warzywa"}, {"qty": 1.0, "unit": "opakowanie", "unitLemma": "opakowanie", "name": "jogurtu", "grams": 150.0, "pantry": false, "tag": "jogurt", "dzial": "nabial"}, {"qty": 1.5, "unit": "garści", "unitLemma": "garść", "name": "mieszanki orzechów", "grams": 45.0, "pantry": false, "tag": "orzechy", "dzial": "bakalie"}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków owsianych", "grams": 20.0, "pantry": false, "tag": "platki-owsiane", "swap": {"group": "platki", "self": "platki-owsiane", "nameCase": "D"}, "dzial": "sypkie"}], "steps": ["Borówki wymieszaj z jogurtem, płatkami i orzechami. Smacznego!"]};
