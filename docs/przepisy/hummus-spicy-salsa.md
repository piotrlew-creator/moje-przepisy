...
<button type="button" class="p-fav p-fav--hero" data-fav="hummus-spicy-salsa" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">0.5 op.</span><span class="p-ing__n">hummusu spicy salsa</span><span class="p-ing__g">80 g</span></div>
...
<li><div class="p-ing__row"><span class="p-ing__q">3 szt.</span><span class="p-ing__n">wafli ryżowych</span><span class="p-ing__g">30 g</span></div>
</li>
...
<li><div class="p-ing__row"><span class="p-ing__q">1 op.</span><span class="p-ing__n">Fruvity pure (banan, truskawka, jabłko)</span><span class="p-ing__g">250 g</span></div>
</li>
</ul>
...
<li><span class="p-step__text">Wafle ryżowe zjedz z hummusem i pomidorkami koktajlowymi. Na deser zjedz jogurt.</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Hummus spicy salsa z waflami ryżowymi">
<div class="p-cook__bar">
<span class="p-cook__title">Hummus spicy salsa z waflami ryżowymi</span>
...
<script>window.RECIPE = {"slug": "hummus-spicy-salsa", "title": "Hummus spicy salsa z waflami ryżowymi", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 458, "times": [null], "ingredients": [{"qty": 0.5, "unit": "opakowania", "unitLemma": "opakowanie", "name": "hummusu spicy salsa", "grams": 80.0, "pantry": false, "tag": "hummus", "swap": {"group": "pasty", "self": "hummus", "nameCase": "D"}, "dzial": "chlodnia"}, {"qty": 3.0, "unit": "sztuki", "unitLemma": "sztuka", "name": "wafli ryżowych", "grams": 30.0, "pantry": false, "tag": "wafle", "dzial": "pieczywo"}, {"qty": 5.0, "unit": "sztuk", "unitLemma": "sztuka", "name": "pomidorków koktajlowych", "grams": 100.0, "pantry": false, "tag": "pomidor", "swap": {"group": "warzywa", "self": "pomidor", "nameCase": "Dpl"}, "dzial": "warzywa"}, {"qty": 1.0, "unit": "opakowanie", "unitLemma": "opakowanie", "name": "Fruvity pure (banan, truskawka, jabłko)", "grams": 250.0, "pantry": false, "tag": "smoothie", "dzial": "napoje"}], "steps": ["Wafle ryżowe zjedz z «0|N|||» i pomidorkami koktajlowymi. Na deser zjedz jogurt."]};
