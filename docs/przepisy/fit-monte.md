...
<button type="button" class="p-fav p-fav--hero" data-fav="fit-monte" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">1 garść</span><span class="p-ing__n">orzechów laskowych</span><span class="p-ing__g">30 g</span></div>
...
<li><div class="p-ing__row"><span class="p-ing__q">1.5 łyżki</span><span class="p-ing__n">kakao</span><span class="p-ing__g">15 g</span></div>
</li>
...
<li><span class="p-step__text">Połowę jogurtu zblenduj z erytrolem, bananem, orzechami i kakao</span></li>
<li><span class="p-step__text">Gotowy krem wyłóż do słoiczka lub miseczki i włóż do lodówki na około godzinę</span></li>
<li><span class="p-step__text">Gdy ciemna warstwa już się schłodzi dodaj pozostały jogurt i posyp kakao i orzechami. Smacznego!</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Fit Monte">
<div class="p-cook__bar">
<span class="p-cook__title">Fit Monte</span>
...
<script>window.RECIPE = {"slug": "fit-monte", "title": "Fit Monte", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 477, "times": [null, null, null], "ingredients": [{"qty": 1.0, "unit": "garść", "unitLemma": "garść", "name": "orzechów laskowych", "grams": 30.0, "pantry": false, "tag": "orzechy", "swap": {"group": "orzechy", "self": "orzechy-laskowe", "nameCase": "M"}, "dzial": "bakalie"}, {"qty": 1.0, "unit": "opakowanie", "unitLemma": "opakowanie", "name": "jogurtu skyr", "grams": 150.0, "pantry": false, "tag": "jogurt", "dzial": "nabial"}, {"qty": 1.5, "unit": "łyżki", "unitLemma": "łyżka", "name": "kakao", "grams": 15.0, "pantry": false, "tag": "kakao", "dzial": "bakalie"}, {"qty": 4.0, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "erytrolu", "grams": 20.0, "pantry": true, "tag": null, "dzial": "bakalie"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "banana", "grams": 120.0, "pantry": false, "tag": "banan", "swap": {"group": "owoce", "self": "banan", "nameCase": "D"}, "dzial": "warzywa"}], "steps": ["Połowę jogurtu zblenduj z erytrolem, «4|N|||», orzechami i kakao", "Gotowy krem wyłóż do słoiczka lub miseczki i włóż do lodówki na około godzinę", "Gdy ciemna warstwa już się schłodzi dodaj pozostały jogurt i posyp kakao i orzechami. Smacznego!"]};
