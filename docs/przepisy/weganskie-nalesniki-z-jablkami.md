...
<button type="button" class="p-fav p-fav--hero" data-fav="weganskie-nalesniki-z-jablkami" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">6 łyżek</span><span class="p-ing__n">napoju roślinnego</span><span class="p-ing__g">90 g</span></div>
...
<li><div class="p-ing__row"><span class="p-ing__q">3 łyżki</span><span class="p-ing__n">mąki pszennej pełnoziarnistej</span><span class="p-ing__g">45 g</span></div>
</li>
...
<li><div class="p-ing__row"><span class="p-ing__q">1 szt.</span><span class="p-ing__n">małego jabłka</span><span class="p-ing__g">100 g</span></div>
<div class="p-ing__swap">
...
<li><span class="p-step__text">Składniki na ciasto naleśnikowe: napój roślinny, odżywkę, mąkę, sól i olej, połącz ze sobą. Smaż naleśniki.</span></li>
<li data-sec="420"><span class="p-step__text">Jabłka zetrzyj na tarce. Do startych jabłek dodaj ksylitol i podgrzej w rondelku przez 7 minut.</span><button type="button" class="p-timer__btn" data-timer="1">&#9201; 7:00</button></li>
<li><span class="p-step__text">Usmażone naleśniki przełóż jabłkami, posyp cynamonem i złóż lub zawiń wedle upodobania. Smacznego!</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Wegańskie naleśniki z jabłkami">
<div class="p-cook__bar">
<span class="p-cook__title">Wegańskie naleśniki z jabłkami</span>
...
<script>window.RECIPE = {"slug": "weganskie-nalesniki-z-jablkami", "title": "Wegańskie naleśniki z jabłkami", "slotLabel": "Kolacja", "time": "18:00-20:00", "baseServings": 1, "kcal": 458, "times": [null, 420, null], "ingredients": [{"qty": 6.0, "unit": "łyżek", "unitLemma": "łyżka", "name": "napoju roślinnego", "grams": 90.0, "pantry": false, "tag": "mleko", "swap": {"group": "mleko", "self": "napoj-roslinny", "nameCase": "D"}, "dzial": "nabial"}, {"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "mąki pszennej pełnoziarnistej", "grams": 45.0, "pantry": false, "tag": "maka", "dzial": "sypkie"}, {"qty": 2.0, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "oleju rzepakowego", "grams": 10.0, "pantry": false, "tag": "oliwa", "swap": {"group": "tluszcz", "self": "olej-rzepakowy", "nameCase": "D"}, "dzial": "sosy"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "małego jabłka", "grams": 100.0, "pantry": false, "tag": "jablko", "swap": {"group": "owoce", "self": "jablko", "nameCase": "D"}, "dzial": "warzywa"}, {"qty": 1.0, "unit": "łyżka", "unitLemma": "łyżka", "name": "ksylitolu", "grams": 15.0, "pantry": true, "tag": null, "dzial": "bakalie"}, {"qty": 1.0, "unit": "szczypta", "unitLemma": "szczypta", "name": "soli", "grams": 0.25, "pantry": true, "tag": null, "dzial": "sosy"}, {"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "wegańskiej odżywki białkowej", "grams": 24.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}, {"qty": 1.0, "unit": "łyżeczka", "unitLemma": "łyżeczka", "name": "cynamonu", "grams": 4.0, "pantry": true, "tag": null, "dzial": "sosy"}], "steps": ["Składniki na ciasto naleśnikowe: «0|B|||», odżywkę, mąkę, sól i olej, połącz ze sobą. Smaż naleśniki.", "«3|Bpl|||U» zetrzyj na tarce. Do startych «3|Dpl|||» dodaj ksylitol i podgrzej w rondelku przez 7 minut.", "Usmażone naleśniki przełóż «3|Npl|||», posyp cynamonem i złóż lub zawiń wedle upodobania. Smacznego!"]};
