...
<button type="button" class="p-fav p-fav--hero" data-fav="spaghetti-z-pesto" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
<div class="p-macro"><span class="p-macro__v">494</span><span class="p-macro__l">kcal</span></div>
...
<li data-order="name"><div class="p-ing__row"><span class="p-ing__q"></span><span class="p-ing__n">Makaron bezglutenowy</span><span class="p-ing__g">60 g</span></div>
</li>
...
<li><span class="p-step__text">Makaron ugotuj al dente zgodnie z instrukcją podaną na opakowaniu.</span></li>
<li><span class="p-step__text">Makaron po ugotowaniu odcedź i zostaw w ganku z niewielką ilością wody, w której się gotował.</span></li>
<li><span class="p-step__text">Do garnka z makaronem dodaj pesto i dokładnie wymieszaj.</span></li>
<li><span class="p-step__text">Makaron wyłóż na talerz. Na spaghetti ułóż ser i pokrojonego na kawałki suszonego pomidora oraz pomidorki koktajlowe. Smacznego!</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Spaghetti z pesto">
<div class="p-cook__bar">
<span class="p-cook__title">Spaghetti z pesto</span>
...
<script>window.RECIPE = {"slug": "spaghetti-z-pesto", "title": "Spaghetti z pesto", "slotLabel": "Obiad", "time": "13:00-16:00", "baseServings": 1, "kcal": 494, "times": [null, null, null, null], "ingredients": [{"qty": 60.0, "unit": "g", "unitLemma": null, "name": "Makaron bezglutenowy", "grams": 60.0, "pantry": false, "tag": "makaron", "nameFirst": true, "weightOnly": true, "dzial": "sypkie"}, {"qty": 3.0, "unit": "plastry", "unitLemma": "plaster", "name": "Ser mozzarella kulka", "grams": 45.0, "pantry": false, "tag": "mozzarella", "nameFirst": true, "dzial": "nabial"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "Pomidory suszone w oleju (odsączone)", "grams": 20.0, "pantry": false, "tag": "oliwa", "nameFirst": true, "dzial": "sosy"}, {"qty": 5.0, "unit": "sztuk", "unitLemma": "sztuka", "name": "Pomidorki koktajlowe", "grams": 100.0, "pantry": false, "tag": "pomidor", "nameFirst": true, "dzial": "warzywa"}, {"qty": 5.0, "unit": "łyżeczek", "unitLemma": "łyżeczka", "name": "Pesto zielone", "grams": 25.0, "pantry": false, "tag": "pesto", "nameFirst": true, "dzial": "sosy"}], "steps": ["Makaron ugotuj al dente zgodnie z instrukcją podaną na opakowaniu.", "Makaron po ugotowaniu odcedź i zostaw w ganku z niewielką ilością wody, w której się gotował.", "Do garnka z makaronem dodaj pesto i dokładnie wymieszaj.", "Makaron wyłóż na talerz. Na spaghetti ułóż ser i pokrojonego na kawałki suszonego pomidora oraz pomidorki koktajlowe. Smacznego!"]};
