...
<li><div class="p-ing__row"><span class="p-ing__q">2 łyżki</span><span class="p-ing__n">płatków owsianych</span><span class="p-ing__g">20 g</span></div>
...
<li><div class="p-ing__row"><span class="p-ing__q">0.5 szklanki</span><span class="p-ing__n">napoju roślinnego np. migdałowego</span><span class="p-ing__g">125 g</span></div>
</li>
...
<li><div class="p-ing__row"><span class="p-ing__q">0.5 garści</span><span class="p-ing__n">mieszanki prażonych orzechów</span><span class="p-ing__g">15 g</span></div>
</li>
...
<li><span class="p-step__text">W rondelku połącz ze sobą płatki owsiane, odżywkę, sól i mleko. Podgrzej przez kilka minut, następnie dodaj czekoladę, masło orzechowe i wymieszaj do momentu połączenia się składników</span></li>
<li><span class="p-step__text">Owsiankę przełóż do miski, dodaj pokrojonego w kostkę banana i posyp orzechami. Smacznego!</span></li>
<li data-sec="120"><span class="p-step__text">Możesz też przygotować owsiankę bez gotowania płatków - wsyp płatki oraz odżywkę do miski z mlekiem i odczekaj 2 minuty.</span><button type="button" class="p-timer__btn" data-timer="2">&#9201; 2:00</button></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Owsianka snickers">
<div class="p-cook__bar">
<span class="p-cook__title">Owsianka snickers</span>
...
<script>window.RECIPE = {"slug": "owsianka-snickers", "title": "Owsianka snickers", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 443, "times": [null, null, 120], "ingredients": [{"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków owsianych", "grams": 20.0, "pantry": false, "tag": "platki-owsiane", "swap": {"group": "platki", "self": "platki-owsiane", "nameCase": "D"}, "dzial": "sypkie"}, {"qty": 0.5, "unit": "szklanki", "unitLemma": "szklanka", "name": "napoju roślinnego np. migdałowego", "grams": 125.0, "pantry": false, "tag": "mleko", "dzial": "nabial"}, {"qty": 1.0, "unit": "porcja", "unitLemma": "porcja", "name": "czekolady gorzkiej", "grams": 10.0, "pantry": false, "tag": "czekolada", "dzial": "bakalie"}, {"qty": 1.0, "unit": "łyżeczka", "unitLemma": "łyżeczka", "name": "masła orzechowego", "grams": 10.0, "pantry": false, "tag": "maslo-orzechowe", "dzial": "bakalie"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "małego banana", "grams": 60.0, "pantry": false, "tag": "banan", "swap": {"group": "owoce", "self": "banan", "nameCase": "D"}, "dzial": "warzywa"}, {"qty": 0.5, "unit": "garści", "unitLemma": "garść", "name": "mieszanki prażonych orzechów", "grams": 15.0, "pantry": false, "tag": "orzechy", "dzial": "bakalie"}, {"qty": 1.0, "unit": "szczypta", "unitLemma": "szczypta", "name": "soli", "grams": 0.25, "pantry": true, "tag": null, "dzial": "sosy"}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "wegańskiej odżywki białkowej", "grams": 16.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}], "steps": ["W rondelku połącz ze sobą «0|B|||», odżywkę, sól i mleko. Podgrzej przez kilka minut, następnie dodaj czekoladę, masło orzechowe i wymieszaj do momentu połączenia się składników", "Owsiankę przełóż do miski, dodaj «4|Bpot|pokrojony_B|w kostkę|» i posyp orzechami. Smacznego!", "Możesz też przygotować owsiankę bez gotowania płatków - wsyp płatki oraz odżywkę do miski z mlekiem i odczekaj 2 minuty."]};
