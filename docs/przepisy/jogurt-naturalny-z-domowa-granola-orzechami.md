...
# Jogurt naturalny z domową granolą, orzechami i żurawiną

<div class="p-hero" data-slot="3">
<div class="p-hero__top">
<span>Kolacja</span><span class="p-num">18:00-20:00</span>
<button type="button" class="p-fav p-fav--hero" data-fav="jogurt-naturalny-z-domowa-granola-orzechami" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">0.5 łyżki</span><span class="p-ing__n">syropu z agawy</span><span class="p-ing__g">8 g</span></div>
<div class="p-ing__swap">
...
<li><div class="p-ing__row"><span class="p-ing__q">0.5 garści</span><span class="p-ing__n">żurawiny suszonej</span><span class="p-ing__g">12.5 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">1 garść</span><span class="p-ing__n">orzechów np. włoskich</span><span class="p-ing__g">30 g</span></div>
</li>
...
<li data-sec="1200"><span class="p-step__text">Domową granolę zrób z: płatków owsianych, syropu z agawy i orzechów. Wszystkie składniki ze sobą wymieszaj, rozłóż na papierze do pieczenia i piecz w temp. 180 stopni przez ok. 20- 30 minut, mieszając co kilka minut. Po upieczeniu ostudź, jak będzie zimna - pokrusz.</span><button type="button" class="p-timer__btn" data-timer="0">&#9201; 20:00</button></li>
<li><span class="p-step__text">Do miseczki dodaj jogurt skyr, suszoną żurawinę i przygotowaną wcześniej granolę. Całość wymieszaj. Smacznego!</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Jogurt naturalny z domową granolą, orzechami i żurawiną">
<div class="p-cook__bar">
<span class="p-cook__title">Jogurt naturalny z domową granolą, orzechami i żurawiną</span>
...
<script>window.RECIPE = {"slug": "jogurt-naturalny-z-domowa-granola-orzechami", "title": "Jogurt naturalny z domową granolą, orzechami i żurawiną", "slotLabel": "Kolacja", "time": "18:00-20:00", "baseServings": 1, "kcal": 467, "times": [1200, null], "ingredients": [{"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków owsianych górskich", "grams": 30.0, "pantry": false, "tag": "platki-owsiane", "swap": {"group": "platki", "self": "platki-owsiane", "nameCase": "D"}, "dzial": "sypkie"}, {"qty": 0.5, "unit": "łyżki", "unitLemma": "łyżka", "name": "syropu z agawy", "grams": 8.0, "pantry": false, "tag": "syrop-agawa", "swap": {"group": "slodziki", "self": "syrop-z-agawy", "nameCase": "D"}, "dzial": "bakalie"}, {"qty": 0.5, "unit": "garści", "unitLemma": "garść", "name": "żurawiny suszonej", "grams": 12.5, "pantry": false, "tag": "zurawina", "dzial": "bakalie"}, {"qty": 1.0, "unit": "garść", "unitLemma": "garść", "name": "orzechów np. włoskich", "grams": 30.0, "pantry": false, "tag": "orzechy", "dzial": "bakalie"}, {"qty": 1.0, "unit": "opakowanie", "unitLemma": "opakowanie", "name": "jogurtu skyr", "grams": 150.0, "pantry": false, "tag": "jogurt", "dzial": "nabial"}], "steps": ["Domową granolę zrób z: «0|D|||», «1|D|||» i orzechów. Wszystkie składniki ze sobą wymieszaj, rozłóż na papierze do pieczenia i piecz w temp. 180 stopni przez ok. 20- 30 minut, mieszając co kilka minut. Po upieczeniu ostudź, jak będzie zimna - pokrusz.", "Do miseczki dodaj jogurt skyr, suszoną żurawinę i przygotowaną wcześniej granolę. Całość wymieszaj. Smacznego!"]};
