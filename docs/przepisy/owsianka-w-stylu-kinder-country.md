...
<button type="button" class="p-fav p-fav--hero" data-fav="owsianka-w-stylu-kinder-country" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<script>window.RECIPE = {"slug": "owsianka-w-stylu-kinder-country", "title": "Owsianka w stylu kinder country", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 478, "times": [null, null, null], "ingredients": [{"qty": 4.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "Płatki owsiane górskie", "grams": 40.0, "pantry": false, "tag": "platki-owsiane", "nameFirst": true, "dzial": "sypkie"}, {"qty": 75.0, "unit": "g", "unitLemma": null, "name": "Mango świeże lub mrożone", "grams": 75.0, "pantry": false, "tag": "mango", "nameFirst": true, "weightOnly": true, "dzial": "warzywa"}, {"qty": 0.6, "unit": "szklanki", "unitLemma": "szklanka", "name": "Mleko roślinne niesłodzone", "grams": 150.0, "pantry": false, "tag": "mleko", "nameFirst": true, "dzial": "nabial"}, {"qty": 1.0, "unit": "łyżeczka", "unitLemma": "łyżeczka", "name": "Masło orzechowe", "grams": 10.0, "pantry": false, "tag": "maslo-orzechowe", "nameFirst": true, "dzial": "bakalie"}, {"qty": 5.0, "unit": "g", "unitLemma": null, "name": "Ryż preparowany", "grams": 5.0, "pantry": false, "tag": "platki-inne", "nameFirst": true, "weightOnly": true, "dzial": "sypkie"}, {"qty": 1.5, "unit": "kostki", "unitLemma": "kostka", "name": "Czekolada mleczna", "grams": 15.0, "pantry": false, "tag": "czekolada", "nameFirst": true, "dzial": "bakalie"}, {"qty": 0.5, "unit": "opakowania", "unitLemma": "opakowanie", "name": "Jogurt skyr", "grams": 75.0, "pantry": false, "tag": "jogurt", "nameFirst": true, "dzial": "nabial"}], "steps": ["Płatki ugotuj w mleku do miękkości (płatki można również zalać gorącym mlekiem i pozostawić, aż zmiękną).", "W miseczce ułóż pokrojone w kostkę mango. Następnie płatki, ryż preparowany, masło orzechowe oraz jogurt.", "Całość polej rozpuszczoną czekoladą."]};
