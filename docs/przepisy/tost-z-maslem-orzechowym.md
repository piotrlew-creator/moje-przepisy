...
<button type="button" class="p-fav p-fav--hero" data-fav="tost-z-maslem-orzechowym" aria-pressed="false" aria-label="Dodaj do ulubionych"><span aria-hidden="true">&#9825;</span></button>
</div>
<div class="p-macros">
...
<script>window.RECIPE = {"slug": "tost-z-maslem-orzechowym", "title": "Tost z chlebem żytnim, masłem orzechowym i bananem + shake białkowy", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 491, "times": [null, null, null], "ingredients": [{"qty": 2.0, "unit": "kromki", "unitLemma": "kromka", "name": "chleba żytniego", "grams": 60.0, "pantry": false, "tag": "chleb", "swap": {"group": "pieczywo", "self": "chleb-zytni", "nameCase": "D"}}, {"qty": 4.0, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "masła orzechowego", "grams": 40.0, "pantry": false, "tag": "maslo-orzechowe"}, {"qty": 0.5, "unit": "sztuki", "unitLemma": "sztuka", "name": "banana", "grams": 60.0, "pantry": false, "tag": "banan", "swap": {"group": "owoce", "self": "banan", "nameCase": "D"}}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "odżywki białkowej", "grams": 16.0, "pantry": false, "tag": "odzywka"}], "steps": ["Pokrojone kromki «0|D|||» przypiecz na patelni", "Pieczywo posmaruj masłem orzechowym i na wierzch ułóż «2|Bpot|pokrojony_B||»", "Z odżywki i wody przygotuj shake, pij do posiłku"]};
