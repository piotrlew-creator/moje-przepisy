...
<button type="button" class="p-fav p-fav--hero" data-fav="tost-z-maslem-orzechowym" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">4 łyżeczki</span><span class="p-ing__n">masła orzechowego</span><span class="p-ing__g">40 g</span></div>
</li>
...
<li><span class="p-step__text">Pokrojone kromki chleba żytniego przypiecz na patelni</span></li>
<li><span class="p-step__text">Pieczywo posmaruj masłem orzechowym i na wierzch ułóż pokrojonego banana</span></li>
<li><span class="p-step__text">Z odżywki i wody przygotuj shake, pij do posiłku</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Tost z chlebem żytnim, masłem orzechowym i bananem + shake białkowy">
<div class="p-cook__bar">
<span class="p-cook__title">Tost z chlebem żytnim, masłem orzechowym i bananem + shake białkowy</span>
...
<script>window.RECIPE = {"slug": "tost-z-maslem-orzechowym", "title": "Tost z chlebem żytnim, masłem orzechowym i bananem + shake białkowy", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 491, "times": [null, null, null], "ingredients": [{"qty": 2.0, "unit": "kromki", "unitLemma": "kromka", "name": "chleba żytniego", "grams": 60.0, "pantry": false, "tag": "chleb", "swap": {"group": "pieczywo", "self": "chleb-zytni", "nameCase": "D"}, "dzial": "pieczywo"}, {"qty": 4.0, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "masła orzechowego", "grams": 40.0, "pantry": false, "tag": "maslo-orzechowe", "dzial": "bakalie"}, {"qty": 0.5, "unit": "sztuki", "unitLemma": "sztuka", "name": "banana", "grams": 60.0, "pantry": false, "tag": "banan", "swap": {"group": "owoce", "self": "banan", "nameCase": "D"}, "dzial": "warzywa"}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "odżywki białkowej", "grams": 16.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}], "steps": ["Pokrojone kromki «0|D|||» przypiecz na patelni", "Pieczywo posmaruj masłem orzechowym i na wierzch ułóż «2|Bpot|pokrojony_B||»", "Z odżywki i wody przygotuj shake, pij do posiłku"]};
