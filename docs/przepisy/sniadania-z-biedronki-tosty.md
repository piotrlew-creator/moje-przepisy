...
# Śniadania z Biedronki: Tosty

<div class="p-hero" data-slot="1">
<div class="p-hero__top">
<span>Śniadanie</span><span class="p-num">7:00-10:00</span>
<button type="button" class="p-fav p-fav--hero" data-fav="sniadania-z-biedronki-tosty" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">4 kromki</span><span class="p-ing__n">chleba tostowego</span><span class="p-ing__g">120 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">0.5 op.</span><span class="p-ing__n">sera mozzarella light</span><span class="p-ing__g">60 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">1 porcja</span><span class="p-ing__n">papryki konserwowej</span><span class="p-ing__g">30 g</span></div>
</li>
</ul>
...
<li><span class="p-step__text">Na kromkach ułóż kolejno ser, pokrojoną paprykę, posyp chili, następnie szynkę i znowu ser.</span></li>
<li><span class="p-step__text">Kromki złóż i umieść w opiekaczu.</span></li>
<li><span class="p-step__text">Piecz sandwicze do momentu, aż kromki się zarumienią, a ser rozpuści.</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Śniadania z Biedronki: Tosty">
<div class="p-cook__bar">
<span class="p-cook__title">Śniadania z Biedronki: Tosty</span>
...
<script>window.RECIPE = {"slug": "sniadania-z-biedronki-tosty", "title": "Śniadania z Biedronki: Tosty", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 477, "times": [null, null, null], "ingredients": [{"qty": 4.0, "unit": "kromki", "unitLemma": "kromka", "name": "chleba tostowego", "grams": 120.0, "pantry": false, "tag": "chleb", "dzial": "pieczywo"}, {"qty": 0.5, "unit": "opakowania", "unitLemma": "opakowanie", "name": "sera mozzarella light", "grams": 60.0, "pantry": false, "tag": "mozzarella", "dzial": "nabial"}, {"qty": 1.0, "unit": "porcja", "unitLemma": "porcja", "name": "papryki konserwowej", "grams": 30.0, "pantry": false, "tag": "papryka-konserwowa", "dzial": "konserwy"}], "steps": ["Na kromkach ułóż kolejno ser, pokrojoną paprykę, posyp chili, następnie szynkę i znowu ser.", "Kromki złóż i umieść w opiekaczu.", "Piecz sandwicze do momentu, aż kromki się zarumienią, a ser rozpuści."]};
