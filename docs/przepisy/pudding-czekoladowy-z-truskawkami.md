...
<button type="button" class="p-fav p-fav--hero" data-fav="pudding-czekoladowy-z-truskawkami" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li data-sec="360"><span class="p-step__text">Wszystkie składniki puddingu gotuj w rondelku przez 6 minut.</span><button type="button" class="p-timer__btn" data-timer="0">&#9201; 6:00</button></li>
<li><span class="p-step__text">Jeżeli składniki się nie połączą, zblenduj na wysokich obrotach.</span></li>
<li><span class="p-step__text">Gotowy pudding przełóż do miseczek i podaj z truskawkami.</span></li>
</ol>
...
<script>window.RECIPE = {"slug": "pudding-czekoladowy-z-truskawkami", "title": "Pudding czekoladowy z truskawkami", "slotLabel": "Kolacja", "time": "18:00-20:00", "baseServings": 1, "kcal": 456, "times": [360, null, null], "ingredients": [{"qty": 0.5, "unit": "szklanki", "unitLemma": "szklanka", "name": "mleka roślinnego np. migdałowe", "grams": 125.0, "pantry": false, "tag": "mleko", "dzial": "nabial"}, {"qty": 1.0, "unit": "garść", "unitLemma": "garść", "name": "truskawek", "grams": 70.0, "pantry": false, "tag": "truskawki", "dzial": "warzywa"}, {"qty": 3.0, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "ksylitolu", "grams": 21.0, "pantry": true, "tag": null, "dzial": "bakalie"}, {"qty": 1.0, "unit": "łyżka", "unitLemma": "łyżka", "name": "kakao", "grams": 10.0, "pantry": false, "tag": "kakao", "dzial": "bakalie"}, {"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków ryżowych", "grams": 36.0, "pantry": false, "tag": "platki-inne", "swap": {"group": "platki", "self": "platki-ryzowe", "nameCase": "M"}, "dzial": "sypkie"}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "wegańskiej odżywki białkowej", "grams": 16.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}, {"qty": 1.0, "unit": "łyżka", "unitLemma": "łyżka", "name": "wiórek kokosowych", "grams": 15.0, "pantry": false, "tag": "wiorki", "dzial": "bakalie"}], "steps": ["Wszystkie składniki puddingu gotuj w rondelku przez 6 minut.", "Jeżeli składniki się nie połączą, zblenduj na wysokich obrotach.", "Gotowy pudding przełóż do miseczek i podaj z truskawkami."]};
