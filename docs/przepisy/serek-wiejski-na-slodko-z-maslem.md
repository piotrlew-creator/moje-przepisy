...
# Serek wiejski na słodko z masłem orzechowym, domową konfiturą jagodową i płatkami owsianymi

<div class="p-hero" data-slot="1">
<div class="p-hero__top">
<span>Śniadanie</span><span class="p-num">7:00-10:00</span>
<button type="button" class="p-fav p-fav--hero" data-fav="serek-wiejski-na-slodko-z-maslem" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">2 łyżeczki</span><span class="p-ing__n">dżemu niskosłodzonego np. jagodowego</span><span class="p-ing__g">30 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">2.5 łyżki</span><span class="p-ing__n">płatków owsianych górskich</span><span class="p-ing__g">25 g</span></div>
<div class="p-ing__swap">
...
<li><span class="p-step__text">Serek wiejski przełóż do miseczki, dodaj masło orzechowe, konfiturę z jagód, i płatki owsiane. Całość wymieszaj.</span></li>
<li><span class="p-step__text">Smacznego :)</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Serek wiejski na słodko z masłem orzechowym, domową konfiturą jagodową i płatkami owsianymi">
<div class="p-cook__bar">
<span class="p-cook__title">Serek wiejski na słodko z masłem orzechowym, domową konfiturą jagodową i płatkami owsianymi</span>
...
<script>window.RECIPE = {"slug": "serek-wiejski-na-slodko-z-maslem", "title": "Serek wiejski na słodko z masłem orzechowym, domową konfiturą jagodową i płatkami owsianymi", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 460, "times": [null, null], "ingredients": [{"qty": 1.0, "unit": "opakowanie", "unitLemma": "opakowanie", "name": "serka wiejskiego", "grams": 200.0, "pantry": false, "tag": "serek-wiejski", "swap": {"group": "twarogowe", "self": "serek-wiejski", "nameCase": "D"}, "dzial": "nabial"}, {"qty": 2.0, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "masła orzechowego", "grams": 20.0, "pantry": false, "tag": "maslo-orzechowe", "dzial": "bakalie"}, {"qty": 2.0, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "dżemu niskosłodzonego np. jagodowego", "grams": 30.0, "pantry": false, "tag": "jagody", "dzial": "warzywa"}, {"qty": 2.5, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków owsianych górskich", "grams": 25.0, "pantry": false, "tag": "platki-owsiane", "swap": {"group": "platki", "self": "platki-owsiane", "nameCase": "D"}, "dzial": "sypkie"}], "steps": ["«0|B|||U» przełóż do miseczki, dodaj masło orzechowe, konfiturę z jagód, i «3|B|||». Całość wymieszaj.", "Smacznego :)"]};
