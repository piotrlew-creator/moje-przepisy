...
# Owsianka brownie z mikrofali

<div class="p-hero" data-slot="1">
<div class="p-hero__top">
<span>Śniadanie</span><span class="p-num">7:00-10:00</span>
<button type="button" class="p-fav p-fav--hero" data-fav="owsianka-brownie-z-mikrofali" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
<div class="p-macro"><span class="p-macro__v">491</span><span class="p-macro__l">kcal</span></div>
<div class="p-macro"><span class="p-macro__v">7 g</span><span class="p-macro__l">białko</span></div>
...
<li data-order="name"><div class="p-ing__row"><span class="p-ing__q">1 szt.</span><span class="p-ing__n">Banan</span><span class="p-ing__g">120 g</span></div>
...
<li data-order="name"><div class="p-ing__row"><span class="p-ing__q">1 kostka</span><span class="p-ing__n">Czekolada gorzka 70%</span><span class="p-ing__g">10 g</span></div>
</li>
...
<li><span class="p-step__text">Płatki owsiane wsyp do miseczki. Dodaj rozgniecionego banana i proszek do pieczenia oraz masło orzechowe. Wymieszaj.</span></li>
<li data-sec="180"><span class="p-step__text">Wstaw do mikrofali na 3 minuty. Na wierzchu ułóż kostki czekolady.</span><button type="button" class="p-timer__btn" data-timer="1">&#9201; 3:00</button></li>
<li><span class="p-step__text">Podaj ze skyrem.</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Owsianka brownie z mikrofali">
<div class="p-cook__bar">
<span class="p-cook__title">Owsianka brownie z mikrofali</span>
...
<script>window.RECIPE = {"slug": "owsianka-brownie-z-mikrofali", "title": "Owsianka brownie z mikrofali", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 491, "times": [null, 180, null], "ingredients": [{"qty": 4.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "Płatki owsiane górskie", "grams": 40.0, "pantry": false, "tag": "platki-owsiane", "nameFirst": true, "dzial": "sypkie"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "Banan", "grams": 120.0, "pantry": false, "tag": "banan", "nameFirst": true, "swap": {"group": "owoce", "self": "banan", "nameCase": "M"}, "dzial": "warzywa"}, {"qty": 1.0, "unit": "kostka", "unitLemma": "kostka", "name": "Czekolada gorzka 70%", "grams": 10.0, "pantry": false, "tag": "czekolada", "nameFirst": true, "dzial": "bakalie"}, {"qty": 2.0, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "Masło orzechowe", "grams": 20.0, "pantry": false, "tag": "maslo-orzechowe", "nameFirst": true, "dzial": "bakalie"}, {"qty": 0.5, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "Proszek do pieczenia", "grams": 2.0, "pantry": true, "tag": null, "nameFirst": true, "dzial": "sypkie"}, {"qty": 0.5, "unit": "opakowania", "unitLemma": "opakowanie", "name": "Jogurt skyr", "grams": 75.0, "pantry": false, "tag": "jogurt", "nameFirst": true, "dzial": "nabial"}], "steps": ["Płatki owsiane wsyp do miseczki. Dodaj rozgniecionego «1|Bpot|||» i proszek do pieczenia oraz masło orzechowe. Wymieszaj.", "Wstaw do mikrofali na 3 minuty. Na wierzchu ułóż kostki czekolady.", "Podaj ze skyrem."]};
