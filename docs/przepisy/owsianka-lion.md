...
<button type="button" class="p-fav p-fav--hero" data-fav="owsianka-lion" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">2 łyżki</span><span class="p-ing__n">płatków Lion</span><span class="p-ing__g">10 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">1 garść</span><span class="p-ing__n">orzechów arachidowych</span><span class="p-ing__g">30 g</span></div>
<div class="p-ing__swap">
...
<option value="orzechy-arachidowe" selected>Orzechy arachidowe · oryginał</option>
...
<li><span class="p-step__text">Płatki owsiane gotuj w mleku z ekstraktem waniliowym, aż będą miękkie. Możesz również zalać płatki zimnym mlekiem i odstawić na kilka minut.</span></li>
<li><span class="p-step__text">Do gotowych płatków dodaj odżywkę białkową, dokładnie wymieszaj i przełóż do miseczki.</span></li>
<li><span class="p-step__text">Posyp płatkami Lion, orzechami i bananem pokrojonym w plasterki.</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Owsianka Lion">
<div class="p-cook__bar">
<span class="p-cook__title">Owsianka Lion</span>
...
<script>window.RECIPE = {"slug": "owsianka-lion", "title": "Owsianka Lion", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 451, "times": [null, null, null], "ingredients": [{"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków owsianych", "grams": 20.0, "pantry": false, "tag": "platki-owsiane", "swap": {"group": "platki", "self": "platki-owsiane", "nameCase": "D"}, "dzial": "sypkie"}, {"qty": 0.5, "unit": "szklanki", "unitLemma": "szklanka", "name": "mleka roślinnego", "grams": 125.0, "pantry": false, "tag": "mleko", "swap": {"group": "mleko", "self": "mleko-roslinne", "nameCase": "D"}, "dzial": "nabial"}, {"qty": 1.5, "unit": "łyżki", "unitLemma": "łyżka", "name": "wegańskiej odżywki białkowej", "grams": 12.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków Lion", "grams": 10.0, "pantry": false, "tag": "platki-inne", "dzial": "sypkie"}, {"qty": 1.0, "unit": "garść", "unitLemma": "garść", "name": "orzechów arachidowych", "grams": 30.0, "pantry": false, "tag": "orzechy", "swap": {"group": "orzechy", "self": "orzechy-arachidowe", "nameCase": "M"}, "dzial": "bakalie"}, {"qty": 0.5, "unit": "sztuki", "unitLemma": "sztuka", "name": "banana", "grams": 60.0, "pantry": false, "tag": "banan", "swap": {"group": "owoce", "self": "banan", "nameCase": "D"}, "dzial": "warzywa"}, {"qty": 0.5, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "ekstraktu waniliowego", "grams": 1.5, "pantry": true, "tag": null, "dzial": "sosy"}], "steps": ["«0|B|||U» gotuj w mleku z ekstraktem waniliowym, aż będą miękkie. Możesz również zalać płatki zimnym mlekiem i odstawić na kilka minut.", "Do gotowych płatków dodaj odżywkę białkową, dokładnie wymieszaj i przełóż do miseczki.", "Posyp płatkami Lion, orzechami i «5|N|||» pokrojonym w plasterki."]};
