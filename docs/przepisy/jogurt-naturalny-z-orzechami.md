...
<div class="p-macros">
<div class="p-macro"><span class="p-macro__v">199</span><span class="p-macro__l">kcal</span></div>
...
<li><div class="p-ing__row"><span class="p-ing__q">9 łyżek</span><span class="p-ing__n">jogurtu naturalnego</span><span class="p-ing__g">180 g</span></div>
</li>
...
<li>Wymieszaj jogurt z orzechami i zjedz w formie przekąski :)</li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Jogurt naturalny z orzechami">
<div class="p-cook__bar">
<span class="p-cook__title">Jogurt naturalny z orzechami</span>
...
<script>window.RECIPE = {"slug": "jogurt-naturalny-z-orzechami", "title": "Jogurt naturalny z orzechami", "slotLabel": "Kolacja", "time": "18:00-20:00", "baseServings": 1, "ingredients": [{"qty": 9.0, "unit": "łyżek", "unitLemma": "łyżka", "name": "jogurtu naturalnego", "grams": 180.0, "pantry": false, "tag": "jogurt"}, {"qty": 0.5, "unit": "garści", "unitLemma": "garść", "name": "mieszanki orzechów", "grams": 15.0, "pantry": false, "tag": "orzechy"}], "steps": ["Wymieszaj jogurt z orzechami i zjedz w formie przekąski :)"]};
