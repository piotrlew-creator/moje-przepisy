...
<button type="button" class="p-fav p-fav--hero" data-fav="kulki-mocy" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">13 szt.</span><span class="p-ing__n">daktyli</span><span class="p-ing__g">65 g</span></div>
</li>
...
<li data-sec="600"><span class="p-step__text">Daktyle namocz we wrzątku przez ok. 10 minut. Następnie wszystkie składniki zblenduj ze sobą, uformuj kulki i obtocz w wiórkach kokosowych. Smacznego!</span><button type="button" class="p-timer__btn" data-timer="0">&#9201; 10:00</button></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Daktylowo-kakaowe kulki mocy z orzechami">
<div class="p-cook__bar">
<span class="p-cook__title">Daktylowo-kakaowe kulki mocy z orzechami</span>
...
<script>window.RECIPE = {"slug": "kulki-mocy", "title": "Daktylowo-kakaowe kulki mocy z orzechami", "slotLabel": "Kolacja", "time": "18:00-20:00", "baseServings": 1, "kcal": 466, "times": [600], "ingredients": [{"qty": 13.0, "unit": "sztuk", "unitLemma": "sztuka", "name": "daktyli", "grams": 65.0, "pantry": false, "tag": "daktyle", "dzial": "bakalie"}, {"qty": 5.0, "unit": "sztuk", "unitLemma": "sztuka", "name": "orzechów włoskich", "grams": 20.0, "pantry": false, "tag": "orzechy", "swap": {"group": "orzechy", "self": "orzechy-wloskie", "nameCase": "D"}, "dzial": "bakalie"}, {"qty": 1.0, "unit": "łyżka", "unitLemma": "łyżka", "name": "kakao", "grams": 10.0, "pantry": false, "tag": "kakao", "dzial": "bakalie"}, {"qty": 1.0, "unit": "łyżka", "unitLemma": "łyżka", "name": "wiórków kokosowych", "grams": 15.0, "pantry": false, "tag": "wiorki", "dzial": "bakalie"}], "steps": ["Daktyle namocz we wrzątku przez ok. 10 minut. Następnie wszystkie składniki zblenduj ze sobą, uformuj kulki i obtocz w wiórkach kokosowych. Smacznego!"]};
