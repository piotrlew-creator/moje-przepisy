...
# Grzanki z gruszką i serem z niebieską pleśnią

<div class="p-hero" data-slot="1">
<div class="p-hero__top">
<span>Śniadanie</span><span class="p-num">7:00-10:00</span>
<button type="button" class="p-fav p-fav--hero" data-fav="grzanki-z-gruszka-i-serem-z" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
<div class="p-macro"><span class="p-macro__v">404</span><span class="p-macro__l">kcal</span></div>
<div class="p-macro"><span class="p-macro__v">6 g</span><span class="p-macro__l">białko</span></div>
...
<li data-order="name"><div class="p-ing__row"><span class="p-ing__q">2 plastry</span><span class="p-ing__n">Ser z niebieską pleśnią, Lazur</span><span class="p-ing__g">30 g</span></div>
</li>
<li data-order="name"><div class="p-ing__row"><span class="p-ing__q">0.5 szt.</span><span class="p-ing__n">Gruszka</span><span class="p-ing__g">65 g</span></div>
<div class="p-ing__swap">
...
<li data-order="name"><div class="p-ing__row"><span class="p-ing__q">0.5 łyżeczki</span><span class="p-ing__n">Oliwa z oliwek</span><span class="p-ing__g">2.5 g</span></div>
<div class="p-ing__swap">
...
<li data-order="name"><div class="p-ing__row"><span class="p-ing__q">2.5 łyżki</span><span class="p-ing__n">Odżywka białkowa</span><span class="p-ing__g">25 g</span></div>
</li>
</ul>
...
<li><span class="p-step__text">Z chleba przygotuj grzanki w piekarniku lub na suchej patelni.</span></li>
<li><span class="p-step__text">Gruszkę pokrój w plasterki. Podsmaż na rozgrzanej oliwie.</span></li>
<li><span class="p-step__text">Na grzankach ułóż gruszkę i plasterki sera.</span></li>
<li><span class="p-step__text">Po posiłku wypij shake białkowy (200ml wody + odżywka białkowa).</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Grzanki z gruszką i serem z niebieską pleśnią">
<div class="p-cook__bar">
<span class="p-cook__title">Grzanki z gruszką i serem z niebieską pleśnią</span>
...
<script>window.RECIPE = {"slug": "grzanki-z-gruszka-i-serem-z", "title": "Grzanki z gruszką i serem z niebieską pleśnią", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 404, "times": [null, null, null, null], "ingredients": [{"qty": 2.0, "unit": "kromki", "unitLemma": "kromka", "name": "Chleb żytni razowy", "grams": 60.0, "pantry": false, "tag": "chleb", "nameFirst": true, "swap": {"group": "pieczywo", "self": "chleb-zytni-razowy", "nameCase": "M"}, "dzial": "pieczywo"}, {"qty": 2.0, "unit": "plastry", "unitLemma": "plaster", "name": "Ser z niebieską pleśnią, Lazur", "grams": 30.0, "pantry": false, "tag": "ser-plesniowy", "nameFirst": true, "dzial": "nabial"}, {"qty": 0.5, "unit": "sztuki", "unitLemma": "sztuka", "name": "Gruszka", "grams": 65.0, "pantry": false, "tag": "gruszka", "nameFirst": true, "swap": {"group": "owoce", "self": "gruszka", "nameCase": "M"}, "dzial": "warzywa"}, {"qty": 0.5, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "Oliwa z oliwek", "grams": 2.5, "pantry": false, "tag": "oliwa", "nameFirst": true, "swap": {"group": "tluszcz", "self": "oliwa", "nameCase": "M"}, "dzial": "sosy"}, {"qty": 2.5, "unit": "łyżki", "unitLemma": "łyżka", "name": "Odżywka białkowa", "grams": 25.0, "pantry": false, "tag": "odzywka", "nameFirst": true, "dzial": "sypkie"}], "steps": ["Z chleba przygotuj grzanki w piekarniku lub na suchej patelni.", "«2|B|||U» pokrój w plasterki. Podsmaż na rozgrzanej oliwie.", "Na grzankach ułóż «2|B|||» i plasterki sera.", "Po posiłku wypij shake białkowy (200ml wody + odżywka białkowa)."]};
