...
<button type="button" class="p-fav p-fav--hero" data-fav="owsianka-z-gruszka" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">1 szt.</span><span class="p-ing__n">małej gruszki</span><span class="p-ing__g">60 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">2 łyżki</span><span class="p-ing__n">migdałów</span><span class="p-ing__g">30 g</span></div>
</li>
...
<li data-pantry="1"><div class="p-ing__row"><span class="p-ing__q">3 szklanki</span><span class="p-ing__n">wody</span><span class="p-ing__g">45 g</span></div>
</li>
</ul>
...
<li data-sec="120"><span class="p-step__text">Do rondelka wlej wodę i dodaj pokrojoną gruszkę, którą duś przez 2-3 minuty.</span><button type="button" class="p-timer__btn" data-timer="0">&#9201; 2:00</button></li>
<li data-sec="300"><span class="p-step__text">Do rondelka dodaj płatki i mleko, podgrzej przez 5 minut.</span><button type="button" class="p-timer__btn" data-timer="1">&#9201; 5:00</button></li>
<li><span class="p-step__text">Zestaw z ognia i wymieszaj owsiankę z odżywką białkową i cynamonem (opcjonalnie).</span></li>
<li><span class="p-step__text">Przełóż owsiankę do miski, dodaj migdały.</span></li>
<li data-sec="120"><span class="p-step__text">Możesz też przygotować owsiankę bez gotowania płatków – wsyp płatki do miski z mlekiem, odczekaj 2 minuty. Dodaj odżywkę białkową, pokrojoną gruszkę i migdały.</span><button type="button" class="p-timer__btn" data-timer="4">&#9201; 2:00</button></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Owsianka z gruszką">
<div class="p-cook__bar">
<span class="p-cook__title">Owsianka z gruszką</span>
...
<script>window.RECIPE = {"slug": "owsianka-z-gruszka", "title": "Owsianka z gruszką", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 468, "times": [120, 300, null, null, 120], "ingredients": [{"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków owsianych", "grams": 30.0, "pantry": false, "tag": "platki-owsiane", "swap": {"group": "platki", "self": "platki-owsiane", "nameCase": "D"}, "dzial": "sypkie"}, {"qty": 0.5, "unit": "szklanki", "unitLemma": "szklanka", "name": "mleka roślinnego", "grams": 125.0, "pantry": false, "tag": "mleko", "swap": {"group": "mleko", "self": "mleko-roslinne", "nameCase": "D"}, "dzial": "nabial"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "małej gruszki", "grams": 60.0, "pantry": false, "tag": "gruszka", "dzial": "warzywa"}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "migdałów", "grams": 30.0, "pantry": false, "tag": "migdaly", "dzial": "bakalie"}, {"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "wegańskiej odżywki białkowej", "grams": 24.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}, {"qty": 3.0, "unit": "szklanki", "unitLemma": "szklanka", "name": "wody", "grams": 45.0, "pantry": true, "tag": null, "dzial": "napoje"}], "steps": ["Do rondelka wlej wodę i dodaj pokrojoną gruszkę, którą duś przez 2-3 minuty.", "Do rondelka dodaj płatki i mleko, podgrzej przez 5 minut.", "Zestaw z ognia i wymieszaj owsiankę z odżywką białkową i cynamonem (opcjonalnie).", "Przełóż owsiankę do miski, dodaj migdały.", "Możesz też przygotować owsiankę bez gotowania płatków – wsyp płatki do miski z mlekiem, odczekaj 2 minuty. Dodaj odżywkę białkową, pokrojoną gruszkę i migdały."]};
