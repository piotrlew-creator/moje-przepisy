...
<button type="button" class="p-fav p-fav--hero" data-fav="omlet-ze-szpinakiem" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">3 szt.</span><span class="p-ing__n">jajek kurzych</span><span class="p-ing__g">168 g</span></div>
</li>
...
<li><div class="p-ing__row"><span class="p-ing__q">9 szt.</span><span class="p-ing__n">pomidorków koktajlowych</span><span class="p-ing__g">180 g</span></div>
<div class="p-ing__swap">
...
<li><span class="p-step__text">Szpinak opłukać i osuszyć.</span></li>
<li><span class="p-step__text">Na patelni dodaj starty czosnek i chwilę podsmaż na wodzie.</span></li>
<li data-sec="60"><span class="p-step__text">Włóż szpinak i mieszając, smaż go przez ok. 1 - 2 minuty aż zwiędnie.</span><button type="button" class="p-timer__btn" data-timer="2">&#9201; 1:00</button></li>
<li><span class="p-step__text">Jajka energicznie roztrzep widelcem z dodatkiem soli i pieprzu.</span></li>
<li><span class="p-step__text">Dodaj szpinak z patelni i wymieszaj całość.</span></li>
<li><span class="p-step__text">Patelnie podgrzej.</span></li>
<li><span class="p-step__text">Wlej masę jajeczną ze szpinakiem i ułóż połówki pomidorków koktajlowych.</span></li>
<li data-sec="300"><span class="p-step__text">Przykryj patelnię pokrywą i podgrzej na małym ogniu, aż masa się zetnie przez ok. 5 minut.</span><button type="button" class="p-timer__btn" data-timer="7">&#9201; 5:00</button></li>
<li><span class="p-step__text">Nałóż na talerz i ciesz się swoim omletem. Zjedz z chlebem! Smacznego!</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Omlet ze szpinakiem">
<div class="p-cook__bar">
<span class="p-cook__title">Omlet ze szpinakiem</span>
...
<script>window.RECIPE = {"slug": "omlet-ze-szpinakiem", "title": "Omlet ze szpinakiem", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 439, "times": [null, null, 60, null, null, null, null, 300, null], "ingredients": [{"qty": 3.0, "unit": "garści", "unitLemma": "garść", "name": "szpinaku", "grams": 75.0, "pantry": false, "tag": "szpinak", "swap": {"group": "liscizielone", "self": "szpinak", "nameCase": "D"}, "dzial": "warzywa"}, {"qty": 3.0, "unit": "sztuki", "unitLemma": "sztuka", "name": "jajek kurzych", "grams": 168.0, "pantry": false, "tag": "jajka", "dzial": "nabial"}, {"qty": 2.0, "unit": "ząbki", "unitLemma": "ząbek", "name": "czosnku", "grams": 12.0, "pantry": false, "tag": "czosnek", "dzial": "warzywa"}, {"qty": 9.0, "unit": "sztuk", "unitLemma": "sztuka", "name": "pomidorków koktajlowych", "grams": 180.0, "pantry": false, "tag": "pomidor", "swap": {"group": "warzywa", "self": "pomidor", "nameCase": "Dpl"}, "dzial": "warzywa"}, {"qty": 1.0, "unit": "szczypta", "unitLemma": "szczypta", "name": "pieprzu", "grams": 0.25, "pantry": true, "tag": null, "dzial": "sosy"}, {"qty": 2.0, "unit": "kromki", "unitLemma": "kromka", "name": "chleba żytniego razowego", "grams": 60.0, "pantry": false, "tag": "chleb", "swap": {"group": "pieczywo", "self": "chleb-zytni-razowy", "nameCase": "D"}, "dzial": "pieczywo"}, {"qty": 1.0, "unit": "szczypta", "unitLemma": "szczypta", "name": "soli", "grams": 0.25, "pantry": true, "tag": null, "dzial": "sosy"}], "steps": ["«0|B|||U» opłukać i osuszyć.", "Na patelni dodaj starty czosnek i chwilę podsmaż na wodzie.", "Włóż «0|B|||» i mieszając, smaż go przez ok. 1 - 2 minuty aż zwiędnie.", "Jajka energicznie roztrzep widelcem z dodatkiem soli i pieprzu.", "Dodaj «0|B|||» z patelni i wymieszaj całość.", "Patelnie podgrzej.", "Wlej masę jajeczną ze «0|N|||» i ułóż połówki pomidorków koktajlowych.", "Przykryj patelnię pokrywą i podgrzej na małym ogniu, aż masa się zetnie przez ok. 5 minut.", "Nałóż na talerz i ciesz się swoim omletem. Zjedz z chlebem! Smacznego!"]};
