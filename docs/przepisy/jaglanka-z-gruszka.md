...
<button type="button" class="p-fav p-fav--hero" data-fav="jaglanka-z-gruszka" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
<div class="p-macro"><span class="p-macro__v">441</span><span class="p-macro__l">kcal</span></div>
...
<li><div class="p-ing__row"><span class="p-ing__q">1 szt.</span><span class="p-ing__n">małej gruszki</span><span class="p-ing__g">65 g</span></div>
</li>
...
<li data-sec="600"><span class="p-step__text">W rondelku zagotuj mleko z płatkami jaglanymi, odżywką białkową i erytrolem. Gotuj przez 10 minut</span><button type="button" class="p-timer__btn" data-timer="0">&#9201; 10:00</button></li>
<li><span class="p-step__text">Połowę gruszki pokrój w drobną kostkę i dodaj do jaglanki, wymieszaj.</span></li>
<li><span class="p-step__text">Jaglankę przełóż do miski. Posyp orzechami.</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Jaglanka z gruszką">
<div class="p-cook__bar">
<span class="p-cook__title">Jaglanka z gruszką</span>
...
<script>window.RECIPE = {"slug": "jaglanka-z-gruszka", "title": "Jaglanka z gruszką", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 441, "times": [600, null, null], "ingredients": [{"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków jaglanych", "grams": 30.0, "pantry": false, "tag": "platki-jaglane", "swap": {"group": "platki", "self": "platki-jaglane", "nameCase": "D"}, "dzial": "sypkie"}, {"qty": 0.5, "unit": "szklanki", "unitLemma": "szklanka", "name": "napoju migdałowego", "grams": 125.0, "pantry": false, "tag": "mleko", "swap": {"group": "mleko", "self": "napoj-migdalowy", "nameCase": "M"}, "dzial": "nabial"}, {"qty": 1.0, "unit": "łyżeczka", "unitLemma": "łyżeczka", "name": "erytrolu", "grams": 5.0, "pantry": true, "tag": null, "dzial": "bakalie"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "małej gruszki", "grams": 65.0, "pantry": false, "tag": "gruszka", "dzial": "warzywa"}, {"qty": 6.0, "unit": "sztuk", "unitLemma": "sztuka", "name": "orzechów włoskich", "grams": 24.0, "pantry": false, "tag": "orzechy", "swap": {"group": "orzechy", "self": "orzechy-wloskie", "nameCase": "D"}, "dzial": "bakalie"}, {"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "wegańskiej odżywki białkowej", "grams": 24.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}], "steps": ["W rondelku zagotuj mleko z «0|N|||», odżywką białkową i erytrolem. Gotuj przez 10 minut", "Połowę gruszki pokrój w drobną kostkę i dodaj do jaglanki, wymieszaj.", "Jaglankę przełóż do miski. Posyp orzechami."]};
