...
<button type="button" class="p-fav p-fav--hero" data-fav="roslinne-kabanosy" aria-pressed="false" aria-label="Dodaj do ulubionych"><span aria-hidden="true">&#9825;</span></button>
</div>
<div class="p-macros">
...
<script>window.RECIPE = {"slug": "roslinne-kabanosy", "title": "Roślinne kabanosy Bez kęsa mięsa Tarczyński z pieczywem i warzywami", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 475, "times": [null], "ingredients": [{"qty": 1.0, "unit": "opakowanie", "unitLemma": "opakowanie", "name": "Roślinne kabanosy Bez kęsa mięsa Tarczyński", "grams": 90.0, "pantry": false, "tag": "kabanosy"}, {"qty": 1.0, "unit": "sztuka", "unitLemma": "sztuka", "name": "pomidora", "grams": 160.0, "pantry": false, "tag": "pomidor", "swap": {"group": "warzywa", "self": "pomidor", "nameCase": "D"}}, {"qty": 1.0, "unit": "opakowanie", "unitLemma": "opakowanie", "name": "Przekąski na 2 śniadanie kasza jaglana-jabłko-cynamon Tymbark", "grams": 100.0, "pantry": true, "tag": null}], "steps": ["Kabanosy zjedz z warzywami. Po posiłku zjedz przekąskę."]};
