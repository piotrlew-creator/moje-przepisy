...
# Krem jaglany z jabłkiem i orzechami

<div class="p-hero" data-slot="1">
<div class="p-hero__top">
<span>Śniadanie</span><span class="p-num">7:00-10:00</span>
<button type="button" class="p-fav p-fav--hero" data-fav="krem-jaglany-z-jablkiem-i-orzechami" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">0.5 szt.</span><span class="p-ing__n">jabłek</span><span class="p-ing__g">75 g</span></div>
<div class="p-ing__swap">
...
<li><div class="p-ing__row"><span class="p-ing__q"></span><span class="p-ing__n">orzechów</span><span class="p-ing__g">20 g</span></div>
</li>
<li data-pantry="1"><div class="p-ing__row"><span class="p-ing__q">0.5 łyżki</span><span class="p-ing__n">ksylitolu</span><span class="p-ing__g">7.5 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">2 łyżki</span><span class="p-ing__n">odżywki białkowej</span><span class="p-ing__g">20 g</span></div>
</li>
</ul>
...
<li><span class="p-step__text">Do rondelka wlej mleko roślinne i zagotuj.</span></li>
<li><span class="p-step__text">W momencie gdy mleko zaczyna się gotować dodaj płatki jaglane i gotuj na wolnym ogniu, mieszając co jakiś czas, aż płatki się rozkleją, a całość zgęstnieje.</span></li>
<li><span class="p-step__text">Gdy masa jest już gotowa, wyłącz ogień pod rondelkiem i całość zmiksuj z odżywką.</span></li>
<li><span class="p-step__text">Do zmiksowanego kremu dodaj jabłko i dokładnie wymieszaj. W razie potrzeby posłódź ksylitolem.</span></li>
<li><span class="p-step__text">Zmiksowany krem jaglany przełóż do miseczki i posyp pokruszonymi orzechami. Smacznego!</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Krem jaglany z jabłkiem i orzechami">
<div class="p-cook__bar">
<span class="p-cook__title">Krem jaglany z jabłkiem i orzechami</span>
...
<script>window.RECIPE = {"slug": "krem-jaglany-z-jablkiem-i-orzechami", "title": "Krem jaglany z jabłkiem i orzechami", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 467, "times": [null, null, null, null, null], "ingredients": [{"qty": 1.0, "unit": "szklanka", "unitLemma": "szklanka", "name": "mleka roślinnego", "grams": 250.0, "pantry": false, "tag": "mleko", "swap": {"group": "mleko", "self": "mleko-roslinne", "nameCase": "D"}, "dzial": "nabial"}, {"qty": 3.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "płatków jaglanych", "grams": 30.0, "pantry": false, "tag": "platki-jaglane", "swap": {"group": "platki", "self": "platki-jaglane", "nameCase": "D"}, "dzial": "sypkie"}, {"qty": 0.5, "unit": "sztuki", "unitLemma": "sztuka", "name": "jabłek", "grams": 75.0, "pantry": false, "tag": "jablko", "swap": {"group": "owoce", "self": "jablko", "nameCase": "M"}, "dzial": "warzywa"}, {"qty": 20.0, "unit": "g", "unitLemma": null, "name": "orzechów", "grams": 20.0, "pantry": false, "tag": "orzechy", "weightOnly": true, "dzial": "bakalie"}, {"qty": 0.5, "unit": "łyżki", "unitLemma": "łyżka", "name": "ksylitolu", "grams": 7.5, "pantry": true, "tag": null, "dzial": "bakalie"}, {"qty": 2.0, "unit": "łyżki", "unitLemma": "łyżka", "name": "odżywki białkowej", "grams": 20.0, "pantry": false, "tag": "odzywka", "dzial": "sypkie"}], "steps": ["Do rondelka wlej «0|B|||» i zagotuj.", "W momencie gdy mleko zaczyna się gotować dodaj «1|B|||» i gotuj na wolnym ogniu, mieszając co jakiś czas, aż płatki się rozkleją, a całość zgęstnieje.", "Gdy masa jest już gotowa, wyłącz ogień pod rondelkiem i całość zmiksuj z odżywką.", "Do zmiksowanego kremu dodaj «2|B|||» i dokładnie wymieszaj. W razie potrzeby posłódź ksylitolem.", "Zmiksowany krem jaglany przełóż do miseczki i posyp pokruszonymi orzechami. Smacznego!"]};
