...
<button type="button" class="p-fav p-fav--hero" data-fav="placuszki-z-truskawkami" aria-pressed="false" aria-label="Dodaj do ulubionych"><svg class="p-heart" viewBox="0 0 32 28" aria-hidden="true" focusable="false"><path d="M16 26.6c-.55 0-1.08-.19-1.5-.54C9 21.6 1 15.7 1 9.5 1 4.8 4.8 1 9.5 1c2.7 0 5.1 1.2 6.5 3.2C17.4 2.2 19.8 1 22.5 1 27.2 1 31 4.8 31 9.5c0 6.2-8 12.1-13.5 16.56-.42.35-.95.54-1.5.54z"/></svg></button>
</div>
<div class="p-macros">
...
<li><div class="p-ing__row"><span class="p-ing__q">5 łyżek</span><span class="p-ing__n">mąki żytniej pełnoziarnistej</span><span class="p-ing__g">50 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">0.5 op.</span><span class="p-ing__n">jogurtu greckiego/skyr</span><span class="p-ing__g">75 g</span></div>
</li>
<li><div class="p-ing__row"><span class="p-ing__q">0.5 garści</span><span class="p-ing__n">truskawek</span><span class="p-ing__g">35 g</span></div>
</li>
...
<li data-pantry="1"><div class="p-ing__row"><span class="p-ing__q">0.5 łyżeczki</span><span class="p-ing__n">sody oczyszczonej</span><span class="p-ing__g">2.5 g</span></div>
</li>
...
<li><span class="p-step__text">W miseczce wymieszaj na gładką masę: jogurt, mąkę, jajka, erytrol, proszek do pieczenia i sodę. Jak masa jest za gęsta, dolej wodę.</span></li>
<li><span class="p-step__text">Rozgrzej patelnie z kilkoma kroplami oliwy. Na rozgrzaną patelnie nałóż po 1 łyżce ciasta, zachowując odstępy pomiędzy plackami. Placki smaż na średnim ogniu.</span></li>
<li data-sec="180"><span class="p-step__text">Gdy na plackach pojawią się pierwsze bąbelki (po około 3 minutach), w każdy placuszek włóż kilka plasterków truskawek.</span><button type="button" class="p-timer__btn" data-timer="2">&#9201; 3:00</button></li>
<li data-sec="120"><span class="p-step__text">Przewróć placki na drugą stronę i smaż około 2-3 minut.</span><button type="button" class="p-timer__btn" data-timer="3">&#9201; 2:00</button></li>
<li><span class="p-step__text">Przed usmażeniem kolejnych placków, wytrzyj patelnie ręcznikiem i ponownie dodaj kilka kropel oliwy. Smacznego!</span></li>
</ol>

<div class="p-cook" id="cook" data-open="0" role="dialog" aria-modal="true" aria-label="Gotowanie: Placuszki z truskawkami">
<div class="p-cook__bar">
<span class="p-cook__title">Placuszki z truskawkami</span>
...
<script>window.RECIPE = {"slug": "placuszki-z-truskawkami", "title": "Placuszki z truskawkami", "slotLabel": "Śniadanie", "time": "7:00-10:00", "baseServings": 1, "kcal": 466, "times": [null, null, 180, 120, null], "ingredients": [{"qty": 5.0, "unit": "łyżek", "unitLemma": "łyżka", "name": "mąki żytniej pełnoziarnistej", "grams": 50.0, "pantry": false, "tag": "maka", "dzial": "sypkie"}, {"qty": 0.5, "unit": "opakowania", "unitLemma": "opakowanie", "name": "jogurtu greckiego/skyr", "grams": 75.0, "pantry": false, "tag": "jogurt", "dzial": "nabial"}, {"qty": 0.5, "unit": "garści", "unitLemma": "garść", "name": "truskawek", "grams": 35.0, "pantry": false, "tag": "truskawki", "dzial": "warzywa"}, {"qty": 2.0, "unit": "sztuki", "unitLemma": "sztuka", "name": "jajek kurzych", "grams": 112.0, "pantry": false, "tag": "jajka", "dzial": "nabial"}, {"qty": 2.0, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "oliwy z oliwek", "grams": 10.0, "pantry": false, "tag": "oliwa", "swap": {"group": "tluszcz", "self": "oliwa", "nameCase": "D"}, "dzial": "sosy"}, {"qty": 0.5, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "proszku do pieczenia", "grams": 2.0, "pantry": true, "tag": null, "dzial": "sypkie"}, {"qty": 0.5, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "sody oczyszczonej", "grams": 2.5, "pantry": true, "tag": null, "dzial": "sypkie"}, {"qty": 2.0, "unit": "łyżeczki", "unitLemma": "łyżeczka", "name": "erytrolu", "grams": 10.0, "pantry": true, "tag": null, "dzial": "bakalie"}], "steps": ["W miseczce wymieszaj na gładką masę: jogurt, mąkę, jajka, erytrol, proszek do pieczenia i sodę. Jak masa jest za gęsta, dolej wodę.", "Rozgrzej patelnie z kilkoma kroplami oliwy. Na rozgrzaną patelnie nałóż po 1 łyżce ciasta, zachowując odstępy pomiędzy plackami. Placki smaż na średnim ogniu.", "Gdy na plackach pojawią się pierwsze bąbelki (po około 3 minutach), w każdy placuszek włóż kilka plasterków truskawek.", "Przewróć placki na drugą stronę i smaż około 2-3 minut.", "Przed usmażeniem kolejnych placków, wytrzyj patelnie ręcznikiem i ponownie dodaj kilka kropel oliwy. Smacznego!"]};
